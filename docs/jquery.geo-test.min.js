...
o=1;p=String(p);if(p.charAt(0)=="#")h=p;else if(/^rgb/.test(p)){o=f(p);h="#";for(var s,x=0;x<3;x++){s=o[x].indexOf("%")!=-1?Math.floor(parseFloat(o[x])/100*255):+o[x];h+=M[l(s,0,255)]}o=+o[3]}else if(/^hsl/.test(p)){x=o=f(p);h=parseFloat(x[0])/360%360;h<0&&h++;s=l(parseFloat(x[1])/100,0,1);x=l(parseFloat(x[2])/100,0,1);if(s==0)s=x=h=x;else{var v=x<0.5?x*(1+s):x+s-x*s,A=2*x-v;s=m(A,v,h+1/3);x=m(A,v,h);h=m(A,v,h-1/3)}h="#"+M[Math.floor(s*255)]+M[Math.floor(x*255)]+M[Math.floor(h*255)];o=o[3]}else h=
...
$.widget||function(g,q){if(g.cleanData){var r=g.cleanData;g.cleanData=function(c){for(var a=0,d;(d=c[a])!=null;a++)try{g(d).triggerHandler("remove")}catch(e){}r(c)}}else{var b=g.fn.remove;g.fn.remove=function(c,a){return this.each(function(){if(!a)if(!c||g.filter(c,[this]).length)g("*",this).add([this]).each(function(){try{g(this).triggerHandler("remove")}catch(d){}});return b.call(g(this),c,a)})}}g.widget=function(c,a,d){var e=c.split(".")[0],f;c=c.split(".")[1];f=e+"-"+c;if(!d){d=a;a=g.Widget}g.expr[":"][f]=
function(l){return!!g.data(l,c)};g[e]=g[e]||{};g[e][c]=function(l,m){arguments.length&&this._createWidget(l,m)};a=new a;a.options=g.extend(true,{},a.options);g[e][c].prototype=g.extend(true,a,{namespace:e,widgetName:c,widgetEventPrefix:g[e][c].prototype.widgetEventPrefix||c,widgetBaseClass:f},d);g.widget.bridge(c,g[e][c])};g.widget.bridge=function(c,a){g.fn[c]=function(d){var e=typeof d==="string",f=Array.prototype.slice.call(arguments,1),l=this;d=!e&&f.length?g.extend.apply(null,[true,d].concat(f)):
d;if(e&&d.charAt(0)==="_")return l;e?this.each(function(){var m=g.data(this,c),n=m&&g.isFunction(m[d])?m[d].apply(m,f):m;if(n!==m&&n!==q){l=n;return false}}):this.each(function(){var m=g.data(this,c);m?m.option(d||{})._init():g.data(this,c,new a(d,this))});return l}};g.Widget=function(c,a){arguments.length&&this._createWidget(c,a)};g.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:false},_createWidget:function(c,a){g.data(a,this.widgetName,this);this.element=g(a);this.options=
...
"-disabled ui-state-disabled")},widget:function(){return this.element},option:function(c,a){var d=c;if(arguments.length===0)return g.extend({},this.options);if(typeof c==="string"){if(a===q)return this.options[c];d={};d[c]=a}this._setOptions(d);return this},_setOptions:function(c){var a=this;g.each(c,function(d,e){a._setOption(d,e)});return this},_setOption:function(c,a){this.options[c]=a;if(c==="disabled")this.widget()[a?"addClass":"removeClass"](this.widgetBaseClass+"-disabled ui-state-disabled").attr("aria-disabled",
a);return this},enable:function(){return this._setOption("disabled",false)},disable:function(){return this._setOption("disabled",true)},_trigger:function(c,a,d){var e,f=this.options[c];d=d||{};a=g.Event(a);a.type=(c===this.widgetEventPrefix?c:this.widgetEventPrefix+c).toLowerCase();a.target=this.element[0];if(c=a.originalEvent)for(e in c)e in a||(a[e]=c[e]);this.element.trigger(a,d);return!(g.isFunction(f)&&f.call(this.element[0],a,d)===false||a.isDefaultPrevented())}}}(jQuery);
...
'"'+o+'"+';else{var E=o[0],N=o[1],O=o[2],S=o[3];o=o[4];var Q=o+'||"")+';O&&x.push(a(O));A+=E==="="?!N||N==="html"?"html("+Q:N==="none"?"("+Q:'enc("'+N+'",'+Q:'tag("'+E+'",$view,"'+(N||"")+'",'+(O?x.length:'""')+","+S+(o?",":"")+o+")+"}}h=new Function("$data, $view",A.slice(0,-1)+";return result;\n\n}catch(e){return views.err(e);}");h.nested=x;return h}function d(h){return R[h]||(R[h]="&#"+h.charCodeAt(0)+";")}function e(h){try{return f(h)}catch(o){}return h}var f,l,m,n,t,u,w,B,I,F,y=false,K=true,
D=g.jQuery,J=/^[^<]*(<[\w\W]+>)[^>]*$|\{\{\! /,P=/^(true|false|null|[\d\.]+)|(\w+|\$(view|data|ctx|(\w+)))([\w\.]*)|((['"])(?:\\\1|.)*\7)$/g,H=/(\$?[\w\.\[\]]+)(?:(\()|\s*(===|!==|==|!=|<|>|<=|>=)\s*|\s*(\=)\s*)?|(\,\s*)|\\?(\')|\\?(\")|(\))|(\s+)/g,C=/\r?\n/g,G=/\\(['"])/g,M=/\\?(['"])/g,z=/\x08([^\x08]+)\x08/g,L=0,R={"&":"&amp;","<":"&lt;",">":"&gt;"},U=/[\x00"&'<>]/g,p=Array.prototype.slice;if(D){f=D;f.fn.extend({render:function(h,o,s,x){return u(h,this[0],o,s,x)},template:function(h,o){return f.template(h,
this[0],o)}})}else{l=g.$;g.JsViews=m=g.$=f={extend:function(h,o){for(var s in o)h[s]=o[s];return h},isArray:Array.isArray||function(h){return Object.prototype.toString.call(h)==="[object Array]"},noConflict:function(){if(g.$===m)g.$=l;return m}}}F=f.extend;F(f,{views:n={templates:{},tags:{"if":function(){var h=this._view;h.onElse=function(o,s){for(var x=0,v=s.length;v&&!s[x++];)if(x===v)return"";h.onElse=q;return u(h.data,o.tmpl,h.ctx,h)};return h.onElse(this,arguments)},"else":function(){var h=this._view;
...
render:u=function(h,o,s,x,v,A){var E,N,O,S,Q="";if(arguments.length===2&&h.jsViews){x=h;s=x.ctx;h=x.data}o=f.template(o);if(!o)return"";if(f.isArray(h)){S=new r(s,v,x,h);E=0;for(N=h.length;E<N;E++){O=(O=h[E])?o(O,new r(s,v,S,O,o,this)):"";Q+=n.activeViews?"<!--item--\>"+O+"<!--/item--\>":O}}else Q+=o(h,new r(s,v,x,h,o));return n.activeViews?"<!--tmpl("+(v||"")+") "+(A?"tag="+A:o._name)+"--\>"+Q+"<!--/tmpl--\>":Q},template:function(h,o){if(o){if(""+o===o)o=c(o);else if(D&&o instanceof f)o=o[0];if(o){if(D&&
o.nodeType)o=f.data(o,"tmpl")||f.data(o,"tmpl",c(o.innerHTML));n.templates[o._name=o._name||h||"_"+L++]=o}return o}return h?""+h!==h?h._name?h:f.template(null,h):n.templates[h]||f.template(null,J.test(h)?h:e(h)):null}});n.setDelimiters("{{","}}")}(window);
(function(g,q,r){var b=Number.POSITIVE_INFINITY,c=Number.NEGATIVE_INFINITY;g.geo={_allCoordinates:function(a){a=this._flatten(a);for(var d=0,e=[];d<a.length;d++){var f=a[d].coordinates,l=f&&g.isArray(f[0]),m=l&&g.isArray(f[0][0]),n;if(!(m&&g.isArray(f[0][0][0]))){if(!m){l||(f=[f]);f=[f]}f=[f]}for(l=0;l<f.length;l++)for(m=0;m<f[l].length;m++)for(n=0;n<f[l][m].length;n++)e.push(f[l][m][n])}return e},_isGeodetic:function(a){for(;g.isArray(a);)if(a.length>1&&!g.isArray(a[0]))return a[0]>=-180&&a[0]<=
180&&a[1]>=-85&&a[1]<=85;else a=a[0];return false},center:function(a,d){var e=false;if(!d&&g.geo.proj&&this._isGeodetic(a)){e=true;a=g.geo.proj.fromGeodetic(a)}var f=[(a[0]+a[2])/2,(a[1]+a[3])/2];return e?g.geo.proj.toGeodetic(f):f},expandBy:function(a,d,e,f){var l=false;if(!f&&g.geo.proj&&this._isGeodetic(a)){l=true;a=g.geo.proj.fromGeodetic(a)}a=[a[0]-d,a[1]-e,a[2]+d,a[3]+e];return l?g.geo.proj.toGeodetic(a):a},height:function(a,d){if(!d&&g.geo.proj&&this._isGeodetic(a))a=g.geo.proj.fromGeodetic(a);
return a[3]-a[1]},_in:function(a,d){return a[0]<=d[0]&&a[1]<=d[1]&&a[2]>=d[2]&&a[3]>=d[3]},_bboxDisjoint:function(a,d){return d[0]>a[2]||d[2]<a[0]||d[1]>a[3]||d[3]<a[1]},reaspect:function(a,d,e){var f=false;if(!e&&g.geo.proj&&this._isGeodetic(a)){f=true;a=g.geo.proj.fromGeodetic(a)}var l=this.width(a,true),m=this.height(a,true);e=this.center(a,true);if(l!=0&&m!=0&&d>0){if(l/m>d){a=l/2;l=a/d}else{l=m/2;a=l*d}a=[e[0]-a,e[1]-l,e[0]+a,e[1]+l]}return f?g.geo.proj.toGeodetic(a):a},recenter:function(a,d,
e){var f=false;if(!e&&g.geo.proj){if(this._isGeodetic(a)){f=true;a=g.geo.proj.fromGeodetic(a)}if(this._isGeodetic(d))d=g.geo.proj.fromGeodetic(d)}e=(a[2]-a[0])/2;a=(a[3]-a[1])/2;a=[d[0]-e,d[1]-a,d[0]+e,d[1]+a];return f?g.geo.proj.toGeodetic(a):a},scaleBy:function(a,d,e){var f=false;if(!e&&g.geo.proj&&this._isGeodetic(a)){f=true;a=g.geo.proj.fromGeodetic(a)}e=this.center(a,true);var l=(a[2]-a[0])*d/2;a=(a[3]-a[1])*d/2;a=[e[0]-l,e[1]-a,e[0]+l,e[1]+a];return f?g.geo.proj.toGeodetic(a):a},width:function(a,
d){if(!d&&g.geo.proj&&this._isGeodetic(a))a=g.geo.proj.fromGeodetic(a);return a[2]-a[0]},bbox:function(a,d){if(a)if(a.bbox)result=!d&&g.geo.proj&&this._isGeodetic(a.bbox)?g.geo.proj.fromGeodetic(a.bbox):a.bbox;else{result=[b,b,c,c];var e=this._allCoordinates(a),f=0;if(e.length==0)return r;var l=false;if(!d&&g.geo.proj&&this._isGeodetic(e)){l=true;e=g.geo.proj.fromGeodetic(e)}for(;f<e.length;f++){result[0]=Math.min(e[f][0],result[0]);result[1]=Math.min(e[f][1],result[1]);result[2]=Math.max(e[f][0],
result[2]);result[3]=Math.max(e[f][1],result[3])}}else return r;return l?g.geo.proj.toGeodetic(result):result},centroid:function(a,d){switch(a.type){case "Point":return g.extend({},a);case "LineString":case "Polygon":var e=0,f=[0,0],l=g.merge([],a.type=="Polygon"?a.coordinates[0]:a.coordinates),m=1,n,t,u=false;if(!d&&g.geo.proj&&this._isGeodetic(l)){u=true;l=g.geo.proj.fromGeodetic(l)}for(;m<=l.length;m++){n=m%l.length;t=l[m-1][0]*l[n][1]-l[n][0]*l[m-1][1];e+=t;f[0]+=(l[m-1][0]+l[n][0])*t;f[1]+=(l[m-
1][1]+l[n][1])*t}if(e==0)if(l.length>0){f[0]=l[0][0];f[1]=l[0][1];return{type:"Point",coordinates:u?g.geo.proj.toGeodetic(f):f}}else break;e*=3;f[0]/=e;f[1]/=e;return{type:"Point",coordinates:u?g.geo.proj.toGeodetic(f):f}}return r},contains:function(a,d){if(a.type!="Polygon")return false;switch(d.type){case "Point":return this._containsPolygonPoint(a.coordinates,d.coordinates);case "LineString":return this._containsPolygonLineString(a.coordinates,d.coordinates);case "Polygon":return this._containsPolygonLineString(a.coordinates,
d.coordinates[0]);default:return false}},_containsPolygonPoint:function(a,d){if(a.length==0||a[0].length<4)return false;for(var e=0,f=a[0][0],l=1,m;l<a[0].length;l++){m=a[0][l];if(f[1]<=d[1]&&d[1]<m[1]||m[1]<=d[1]&&d[1]<f[1]&&(d[0]<f[0]||d[0]<m[0])){f=f[0]+(m[0]-f[0])*(d[1]-f[1])/(m[1]-f[1]);f>d[0]&&e++}f=m}return e%2==1},_containsPolygonLineString:function(a,d){for(var e=0;e<d.length;e++)if(!this._containsPolygonPoint(a,d[e]))return false;return true},distance:function(a,d,e){var f=!e&&g.geo.proj&&
this._isGeodetic(a.coordinates)?g.geo.proj.fromGeodetic(a.coordinates):a.coordinates;e=!e&&g.geo.proj&&this._isGeodetic(d.coordinates)?g.geo.proj.fromGeodetic(d.coordinates):d.coordinates;switch(a.type){case "Point":switch(d.type){case "Point":return this._distancePointPoint(e,f);case "LineString":return this._distanceLineStringPoint(e,f);case "Polygon":return this._containsPolygonPoint(e,f)?0:this._distanceLineStringPoint(e[0],f);default:return r}case "LineString":switch(d.type){case "Point":return this._distanceLineStringPoint(f,
e);case "LineString":return this._distanceLineStringLineString(f,e);case "Polygon":return this._containsPolygonLineString(e,f)?0:this._distanceLineStringLineString(e[0],f);default:return r}case "Polygon":switch(d.type){case "Point":return this._containsPolygonPoint(f,e)?0:this._distanceLineStringPoint(f[0],e);case "LineString":return this._containsPolygonLineString(f,e)?0:this._distanceLineStringLineString(f[0],e);case "Polygon":return this._containsPolygonLineString(f,e[0])?0:this._distanceLineStringLineString(f[0],
e[0]);default:return r}}},_distancePointPoint:function(a,d){var e=d[0]-a[0],f=d[1]-a[1];return Math.sqrt(e*e+f*f)},_distanceLineStringPoint:function(a,d){var e=b;if(a.length>0){var f=a[0],l=d[0]-f[0],m=d[1]-f[1];if(a.length==1)return Math.sqrt(l*l+m*m);else for(var n=1;n<a.length;n++){var t=a[n],u=d[0]-t[0],w=d[1]-t[1];f=this._distanceSegmentPoint(t[0]-f[0],t[1]-f[1],l,m,u,w);if(f==0)return 0;if(f<e)e=f;f=t;l=u;m=w}}return Math.sqrt(e)},_distanceSegmentPoint:function(a,d,e,f,l,m){var n=a*e+d*f;if(n<=
0)return e*e+f*f;a=a*a+d*d;if(n>=a)return l*l+m*m;return e*e+f*f-n*n/a},_distanceLineStringLineString:function(a,d){for(var e=b,f=0;f<d.length;f++)e=Math.min(e,this._distanceLineStringPoint(a,d[f]));return e},_buffer:function(a,d,e){var f=false,l=a.coordinates;if(!e&&g.geo.proj&&this._isGeodetic(a.coordinates)){f=true;l=g.geo.proj.fromGeodetic(a.coordinates)}switch(a.type){case "Point":a=[];e=0;for(var m;e<=180;e++){m=e*360/180*(Math.PI/180);a.push([l[0]+Math.cos(m)*d,l[1]+Math.sin(m)*d])}return{type:"Polygon",
coordinates:[f?g.geo.proj.toGeodetic(a):a]};default:return r}},_flatten:function(a){var d=[],e=0;switch(a.type){case "Feature":g.merge(d,this._flatten(a.geometry));break;case "FeatureCollection":for(;e<a.features.length;e++)g.merge(d,this._flatten(a.features[e].geometry));break;case "GeometryCollection":for(;e<a.geometries.length;e++)g.merge(d,this._flatten(a.geometries[e]));break;default:d[0]=a}return d},length:function(a,d){var e=0,f,l=1,m,n;switch(a.type){case "Point":return 0;case "LineString":f=
a.coordinates;break;case "Polygon":f=a.coordinates[0]}if(f){if(!d&&g.geo.proj&&this._isGeodetic(f))f=g.geo.proj.fromGeodetic(f);for(;l<f.length;l++){m=f[l][0]-f[l-1][0];n=f[l][1]-f[l-1][1];e+=Math.sqrt(m*m+n*n)}return e}},area:function(a,d){var e=0,f,l=1,m;switch(a.type){case "Point":case "LineString":return 0;case "Polygon":f=a.coordinates[0]}if(f){if(!d&&g.geo.proj&&this._isGeodetic(f))f=g.geo.proj.fromGeodetic(f);for(;l<=f.length;l++){m=l%f.length;e+=(f[l-1][0]-f[m][0])*(f[l-1][1]+f[m][1])/2}return Math.abs(e)}},
pointAlong:function(a,d,e){var f=0,l=0,m=0,n,t=[],u=1,w=false;switch(a.type){case "Point":return g.extend({},a);case "LineString":n=a.coordinates;break;case "Polygon":n=a.coordinates[0]}if(n)if(d===0)return{type:"Point",coordinates:[n[0][0],n[0][1]]};else if(d===1){u=n.length-1;return{type:"Point",coordinates:[n[u][0],n[u][1]]}}else{if(!e&&g.geo.proj&&this._isGeodetic(n)){w=true;n=g.geo.proj.fromGeodetic(n)}for(;u<n.length;u++){a=n[u][0]-n[u-1][0];e=n[u][1]-n[u-1][1];a=Math.sqrt(a*a+e*e);t.push(a);
f+=a}for(u=0;u<t.length&&m<d;u++){l=m;m+=t[u]/f}d=d-l;f=n[u-1];n=n[u];n=[f[0]+d*(n[0]-f[0]),f[1]+d*(n[1]-f[1])];return{type:"Point",coordinates:w?g.geo.proj.toGeodetic(n):n}}},_WKT:function(){function a(f){if(f&&f.length){for(var l=[],m=0;m<f.length;m++)l.push(f[m].join(" "));return"("+l+")"}else return"EMPTY"}function d(f){if(f&&f.length){for(var l=[],m=0;m<f.length;m++)l.push(a(f[m]));return"("+l+")"}else return"EMTPY"}function e(f){if(f&&f.type)switch(f.type){case "Point":return"POINT "+(f.coordinates&&
...
0;m<f.length;m++)l.push(e(f[m]));f="("+f+")"}else f="EMPTY";return"GEOMETRYCOLLECTION "+f;default:return""}else return""}return{stringify:e,parse:function(f){f=g.trim(f);var l=f.indexOf(" "),m=f.substr(l+1);switch(f.substr(0,l).toUpperCase()){case "POINT":return(f=m.match(/\(\s*([\d\.-]+)\s+([\d\.-]+)\s*\)/))&&f.length>2?{type:"Point",coordinates:[parseFloat(f[1]),parseFloat(f[2])]}:null;case "LINESTRING":m=m.match(/\s*\((.*)\)/);f=[];var n;l=0;if(m.length>1){for(m=m[1].match(/[\d\.-]+\s+[\d\.-]+/g);l<
...
return[6378137*a[0]*0.017453292519943295,6378137*Math.log(Math.tan(0.7853981633974483+a[1]*0.017453292519943295/2))]},fromGeodetic:function(a){if(!g.geo._isGeodetic(a))return a;var d=g.isArray(a[0]),e=this.fromGeodeticPos;if(!d&&a.length==4){d=e([a[0],a[1]]);a=e([a[2],a[3]]);return[d[0],d[1],a[0],a[1]]}else{var f=d&&g.isArray(a[0][0]),l=f&&g.isArray(a[0][0][0]),m=[],n,t,u;if(!l){if(!f){d||(a=[a]);a=[a]}a=[a]}for(n=0;n<a.length;n++){m[n]=[];for(t=0;t<a[n].length;t++){m[n][t]=[];for(u=0;u<a[n][t].length;u++)m[n][t][u]=
e(a[n][t][u])}}return l?m:f?m[0]:d?m[0][0]:m[0][0][0]}},toGeodeticPos:function(a){return[a[0]/6378137*57.29577951308232,(1.5707963267948966-2*Math.atan(1/Math.exp(a[1]/6378137)))*57.29577951308232]},toGeodetic:function(a){if(g.geo._isGeodetic(a))return a;var d=g.isArray(a[0]),e=this.toGeodeticPos;if(!d&&a.length==4){d=e([a[0],a[1]]);a=e([a[2],a[3]]);return[d[0],d[1],a[0],a[1]]}else{var f=d&&g.isArray(a[0][0]),l=f&&g.isArray(a[0][0][0]),m=[];if(!l){if(!f){d||(a=[a]);a=[a]}a=[a]}for(i=0;i<a.length;i++){m[i]=
[];for(j=0;j<a[i].length;j++){m[i][j]=[];for(k=0;k<a[i][j].length;k++)m[i][j][k]=e(a[i][j][k])}}return l?m:f?m[0]:d?m[0][0]:m[0][0][0]}}}}(),_serviceTypes:{}}})(jQuery,this);
...
'" height="'+this._height+'"';if(document.createElement("canvas").getContext){this._$elem.append("<canvas "+c+' style="position:absolute;left:0;top:0;margin:0;padding:0;"></canvas>');this._$canvas=this._$elem.children(":last");this._context=this._$canvas[0].getContext("2d");this._$elem.append("<canvas "+c+' style="position:absolute;left:0;top:0;margin:0;padding:0; visibility: hidden;"></canvas>');this._$blitcanvas=this._$elem.children(":last");this._blitcontext=this._$blitcanvas[0].getContext("2d")}else if(r<=
8){this._trueCanvas=false;this._$elem.append("<div "+c+' style="position:absolute;left:0;top:0;margin:0;padding:0;'+b+'"></div>');this._$canvas=this._$elem.children(":last");G_vmlCanvasManager.initElement(this._$canvas[0]);this._context=this._$canvas[0].getContext("2d");this._$canvas.children().css({backgroundColor:"transparent",width:this._width,height:this._height})}this._$elem.append('<div class="geo-labels-container" style="position:absolute;left:0;top:0;margin:0;padding:0;'+b+'"></div>');this._$labelsContainer=
this._$elem.children(":last")},_setOption:function(b,c){if(b=="style")c=g.extend({},this._options.style,c);g.Widget.prototype._setOption.apply(this,arguments)},destroy:function(){g.Widget.prototype.destroy.apply(this,arguments);this._$elem.html("");this._$elem.removeClass("geo-graphics")},clear:function(){this._context.clearRect(0,0,this._width,this._height);this._$labelsContainer.html("")},drawArc:function(b,c,a,d){d=this._getGraphicStyle(d);if(d.visibility!="hidden"&&d.opacity>0&&d.widthValue>0&&
d.heightValue>0){var e=Math.min(d.widthValue,d.heightValue)/2;c=c*Math.PI/180;a=a*Math.PI/180;this._context.save();this._context.translate(b[0],b[1]);d.widthValue>d.heightValue?this._context.scale(d.widthValue/d.heightValue,1):this._context.scale(1,d.heightValue/d.widthValue);this._context.beginPath();this._context.arc(0,0,e,c,a,false);this._trueCanvas&&this._context.restore();if(d.doFill){this._context.fillStyle=d.fill;this._context.globalAlpha=d.opacity*d.fillOpacity;this._context.fill()}if(d.doStroke){this._context.lineJoin=
"round";this._context.lineWidth=d.strokeWidthValue;this._context.strokeStyle=d.stroke;this._context.globalAlpha=d.opacity*d.strokeOpacity;this._context.stroke()}this._trueCanvas||this._context.restore()}},drawPoint:function(b,c){c=this._getGraphicStyle(c);if(c.widthValue==c.heightValue&&c.heightValue==c.borderRadiusValue)this.drawArc(b,0,360,c);else if(c.visibility!="hidden"&&c.opacity>0){c.borderRadiusValue=Math.min(Math.min(c.widthValue,c.heightValue)/2,c.borderRadiusValue);b[0]-=c.widthValue/2;
b[1]-=c.heightValue/2;this._context.beginPath();this._context.moveTo(b[0]+c.borderRadiusValue,b[1]);this._context.lineTo(b[0]+c.widthValue-c.borderRadiusValue,b[1]);this._context.quadraticCurveTo(b[0]+c.widthValue,b[1],b[0]+c.widthValue,b[1]+c.borderRadiusValue);this._context.lineTo(b[0]+c.widthValue,b[1]+c.heightValue-c.borderRadiusValue);this._context.quadraticCurveTo(b[0]+c.widthValue,b[1]+c.heightValue,b[0]+c.widthValue-c.borderRadiusValue,b[1]+c.heightValue);this._context.lineTo(b[0]+c.borderRadiusValue,
b[1]+c.heightValue);this._context.quadraticCurveTo(b[0],b[1]+c.heightValue,b[0],b[1]+c.heightValue-c.borderRadiusValue);this._context.lineTo(b[0],b[1]+c.borderRadiusValue);this._context.quadraticCurveTo(b[0],b[1],b[0]+c.borderRadiusValue,b[1]);this._context.closePath();if(c.doFill){this._context.fillStyle=c.fill;this._context.globalAlpha=c.opacity*c.fillOpacity;this._context.fill()}if(c.doStroke){this._context.lineJoin="round";this._context.lineWidth=c.strokeWidthValue;this._context.strokeStyle=c.stroke;
this._context.globalAlpha=c.opacity*c.strokeOpacity;this._context.stroke()}}},drawLineString:function(b,c){this._drawLines([b],false,c)},drawPolygon:function(b,c){if(!this._trueCanvas||b.length==1)this._drawLines(b,true,c);else if(!(!b||!b.length||b[0].length<3)){c=this._getGraphicStyle(c);var a,d,e;if(c.visibility!="hidden"&&c.opacity>0){this._blitcontext.clearRect(0,0,this._width,this._height);if(c.doFill)if(b.length>1){this._blitcontext.globalCompositeOperation="source-out";for(d=this._blitcontext.globalAlpha=
1;d<b.length;d++){this._blitcontext.beginPath();this._blitcontext.moveTo(b[d][0][0],b[d][0][1]);for(e=1;e<b[d].length;e++)this._blitcontext.lineTo(b[d][e][0],b[d][e][1]);this._blitcontext.closePath();this._blitcontext.fill()}}this._blitcontext.beginPath();this._blitcontext.moveTo(b[0][0][0],b[0][0][1]);a=[b[0][0][0]-c.strokeWidthValue,b[0][0][1]-c.strokeWidthValue,b[0][0][0]+c.strokeWidthValue,b[0][0][1]+c.strokeWidthValue];for(d=1;d<b[0].length-1;d++){this._blitcontext.lineTo(b[0][d][0],b[0][d][1]);
a[0]=Math.min(b[0][d][0]-c.strokeWidthValue,a[0]);a[1]=Math.min(b[0][d][1]-c.strokeWidthValue,a[1]);a[2]=Math.max(b[0][d][0]+c.strokeWidthValue,a[2]);a[3]=Math.max(b[0][d][1]+c.strokeWidthValue,a[3])}this._blitcontext.closePath();this._blitcontext.globalCompositeOperation="source-out";if(c.doFill){this._blitcontext.fillStyle=c.fill;this._blitcontext.globalAlpha=c.opacity*c.fillOpacity;this._blitcontext.fill()}this._blitcontext.globalCompositeOperation="source-over";if(c.doStroke){this._blitcontext.lineCap=
this._blitcontext.lineJoin="round";this._blitcontext.lineWidth=c.strokeWidthValue;this._blitcontext.strokeStyle=c.stroke;this._blitcontext.globalAlpha=c.opacity*c.strokeOpacity;this._blitcontext.stroke();if(b.length>1)for(d=1;d<b.length;d++){this._blitcontext.beginPath();this._blitcontext.moveTo(b[d][0][0],b[d][0][1]);for(e=1;e<b[d].length;e++)this._blitcontext.lineTo(b[d][e][0],b[d][e][1]);this._blitcontext.closePath();this._blitcontext.stroke()}}a[0]=Math.max(a[0],0);a[1]=Math.max(a[1],0);a[2]=
Math.min(a[2],this._width);a[3]=Math.min(a[3],this._height);this._context.drawImage(this._$blitcanvas[0],a[0],a[1],a[2]-a[0],a[3]-a[1],a[0],a[1],a[2]-a[0],a[3]-a[1])}}},drawBbox:function(b,c){this._drawLines([[[b[0],b[1]],[b[0],b[3]],[b[2],b[3]],[b[2],b[1]],[b[0],b[1]]]],true,c)},drawLabel:function(b,c){this._$labelsContainer.append('<div class="geo-label" style="position:absolute; left:'+b[0]+"px; top:"+b[1]+'px;">'+c+"</div>")},resize:function(){this._width=this._$elem.width();this._height=this._$elem.height();
if(!(this._width&&this._height)){this._width=parseInt(this._$elem.css("width"));this._height=parseInt(this._$elem.css("height"))}if(this._trueCanvas){this._$canvas[0].width=this._width;this._$canvas[0].height=this._height}this._$labelsContainer.css({width:this._width,height:this._height})},_getGraphicStyle:function(b){function c(a){a=parseInt(a);return+a+""===a?+a:a}b=g.extend({},this._options.style,b);b.borderRadiusValue=c(b.borderRadius);b.fill=b.fill||b.color;b.doFill=b.fill&&b.fillOpacity>0;b.stroke=
b.stroke||b.color;b.strokeWidthValue=c(b.strokeWidth);b.doStroke=b.stroke&&b.strokeOpacity>0&&b.strokeWidthValue>0;b.widthValue=c(b.width);b.heightValue=c(b.height);return b},_drawLines:function(b,c,a){if(!(!b||!b.length||b[0].length<2)){a=this._getGraphicStyle(a);var d,e;if(a.visibility!="hidden"&&a.opacity>0){this._context.beginPath();for(d=0;d<b.length;d++){this._context.moveTo(b[d][0][0],b[d][0][1]);for(e=1;e<b[d].length;e++)this._context.lineTo(b[d][e][0],b[d][e][1])}c&&this._context.closePath();
if(c&&a.doFill){this._context.fillStyle=a.fill;this._context.globalAlpha=a.opacity*a.fillOpacity;this._context.fill()}if(a.doStroke){this._context.lineCap=this._context.lineJoin="round";this._context.lineWidth=a.strokeWidthValue;this._context.strokeStyle=a.stroke;this._context.globalAlpha=a.opacity*a.strokeOpacity;this._context.stroke()}}}}})})(jQuery);
...
false,true)},append:function(b){if(b&&g.isPlainObject(b)){var c,a,d,e,f,l;c=b.type=="FeatureCollection"?b.features:g.isArray(b)?b:[b];for(d=1;d<arguments.length;d++){a=arguments[d];if(typeof a==="object")e=a;else if(typeof a==="number"||typeof a==="string")f=a;else if(typeof a==="boolean")l=a}for(d=0;d<c.length;d++){if(c[d].type!="Point"){a=g.geo.bbox(c[d]);if(g.geo.proj&&g.geo._isGeodetic(a))a=g.geo.proj.fromGeodetic(a);g.data(c[d],"geoBbox",a)}this._graphicShapes.push({shape:c[d],style:e,label:f})}if(l===
q||l)this._refresh()}},empty:function(b){for(var c=0;c<this._graphicShapes.length;c++)g.removeData(this._graphicShapes[c].shape,"geoBbox");this._graphicShapes=[];if(b===q||b)this._refresh()},find:function(b,c){var a=g.isPlainObject(b);a&&this._map.toPixel(b.coordinates);for(var d=this._map._pixelSize*c,e=[],f,l,m,n=0;n<this._graphicShapes.length;n++){f=this._graphicShapes[n];if(a)if(f.shape.type=="Point")g.geo.distance(f.shape,b)<=d&&e.push(f.shape);else{l=g.data(f.shape,"geoBbox");l={type:"Polygon",
coordinates:[[[l[0],l[1]],[l[0],l[3]],[l[2],l[3]],[l[2],l[1]],[l[0],l[1]]]]};m={type:"Point",coordinates:g.geo.proj&&g.geo._isGeodetic(b.coordinates)?g.geo.proj.fromGeodetic(b.coordinates):b.coordinates};if(g.geo.distance(l,m,true)<=d){l=g.geo._flatten(f.shape);for(m=0;m<l.length;m++)if(g.geo.distance(l[m],b)<=d){e.push(f.shape);break}}}else e.push(f.shape)}this._$elem.is(".geo-map")&&this._$elem.find(".geo-service").each(function(){e=g.merge(e,g(this).geomap("find",b,c))});return e},remove:function(b,
...
this).geomap();b.attr&&this._$attrList.append("<li>"+b.attr+"</li>")}this._$attrList.find("a").css({position:"relative",zIndex:100})},_refreshDrawing:function(){this._$drawContainer.geographics("clear");if(this._drawPixels.length>0){var b=this._options.mode,c=this._drawPixels,a=this._drawCoords,d,e;switch(b){case "measureLength":b="drawLineString";e={type:"LineString",coordinates:a};d=g.render({length:g.geo.length(e,true)},"geoMeasureLength");e=g.merge([],c[c.length-1]);break;case "measureArea":b=
"drawPolygon";e={type:"Polygon",coordinates:[g.merge([],a)]};e.coordinates[0].push(a[0]);d=g.render({area:g.geo.area(e,true)},"geoMeasureArea");e=g.merge([],c[c.length-1]);c=[c];break;case "drawPolygon":c=[c]}this._$drawContainer.geographics(b,c);if(d){this._$measureLabel.html(d);b=this._contentBounds.width-(this._$measureLabel.outerWidth(true)+e[0]);c=this._contentBounds.height-(this._$measureLabel.outerHeight(true)+e[1]);if(b<0)e[0]+=b;if(c<0)e[1]+=c;this._$measureLabel.css({left:e[0],top:e[1]}).show()}}},
_resetDrawing:function(){this._drawPixels=[];this._drawCoords=[];this._$drawContainer.geographics("clear");this._$measureLabel.hide()},_refreshShapes:function(b,c,a,d,e,f){var l,m,n,t,u,w,B,I=this._map._getBbox(e,f);for(l=0;l<c.length;l++){n=c[l].shape||c[l];n=n.geometry||n;m=g.data(n,"geoBbox");if(!(m&&g.geo._bboxDisjoint(I,m))){t=g.isArray(a)?a[l].style:a;u=g.isArray(d)?d[l].label:d;w=u!==q;B=q;switch(n.type){case "Point":B=this._map.toPixel(n.coordinates,e,f);this._$shapesContainer.geographics("drawPoint",
B,t);break;case "LineString":this._$shapesContainer.geographics("drawLineString",this._map.toPixel(n.coordinates,e,f),t);if(w)B=this._map.toPixel(g.geo.pointAlong(n,0.5).coordinates,e,f);break;case "Polygon":this._$shapesContainer.geographics("drawPolygon",this._map.toPixel(n.coordinates,e,f),t);if(w)B=this._map.toPixel(g.geo.centroid(n).coordinates,e,f);break;case "MultiPoint":for(m=0;m<n.coordinates.length;m++)this._$shapesContainer.geographics("drawPoint",this._map.toPixel(n.coordinates[m],e,f),
t);if(w)B=this._map.toPixel(g.geo.centroid(n).coordinates,e,f);break;case "MultiLineString":for(m=0;m<n.coordinates.length;m++)this._$shapesContainer.geographics("drawLineString",this._map.toPixel(n.coordinates[m],e,f),t);if(w)B=this._map.toPixel(g.geo.centroid(n).coordinates,e,f);break;case "MultiPolygon":for(m=0;m<n.coordinates.length;m++)this._$shapesContainer.geographics("drawPolygon",this._map.toPixel(n.coordinates[m],e,f),t);if(w)B=this._map.toPixel(g.geo.centroid(n).coordinates,e,f);break;
case "GeometryCollection":this._refreshShapes(b,n.geometries,t,u,e,f)}w&&B&&this._$shapesContainer.geographics("drawLabel",B,u)}}},_findMapSize:function(){for(var b={width:0,height:0},c=this._$elem;c.size()&&!(b.width>0&&b.height>0);){b={width:c.width(),height:c.height()};if(b.width<=0||b.height<=0)b={width:parseInt(c.css("width")),height:parseInt(c.css("height"))};c=c.parent()}return b},_forcePosition:function(b){var c=b.css("position");c!="relative"&&c!="absolute"&&c!="fixed"&&b.css("position",
...
this._setCenterAndSize([this._center[0]+b,this._center[1]+c],this._pixelSize,true,true);this._$eventTarget.css("cursor",this._options.cursors[this._options.mode]);this._inOp=false;this._anchor=this._current;this._mouseDown=this._toolPan=this._panning=false}},_panMove:function(){if(this._options.pannable){var b=this._current[0]-this._lastDrag[0],c=this._current[1]-this._lastDrag[1],a=0,d,e;if(this._toolPan||b>3||b<-3||c>3||c<-3){if(!this._toolPan){this._toolPan=true;this._$eventTarget.css("cursor",
this._options.cursors.pan)}if(this._mouseDown)this._velocity=[b,c];if(b!=0||c!=0){this._panning=true;this._lastDrag=this._current;e={left:function(f,l){return parseInt(l)+b},top:function(f,l){return parseInt(l)+c}};for(a=0;a<this._currentServices.length;a++){d=this._currentServices[a];g.geo._serviceTypes[d.type].interactivePan(this,d,b,c);d.serviceContainer.find(".geo-shapes-container").css(e)}this._$panContainer.css(e)}}}},_refresh:function(){var b,c=0;if(this._$elem.is(".geo-map"))for(;c<this._currentServices.length;c++){b=
...
c){this._$elem.find(".geo-shapes-container").geographics("clear");for(var e=0;e<this._currentServices.length;e++){var f=this._currentServices[e];g.geo._serviceTypes[f.type].interactiveScale(this,f,b,c)}}this._center=g.merge([],b);this._options.pixelSize=this._pixelSize=c;if(this._userGeodetic){this._options.bbox=g.geo.proj.toGeodetic(this._getBbox());this._options.center=g.geo.proj.toGeodetic(this._center)}else{this._options.bbox=this._getBbox();this._options.center=g.merge([],b)}this._options.zoom=
this._getZoom();if(this._drawCoords.length>0)this._drawPixels=this._toPixel(this._drawCoords);a&&this._trigger("bboxchange",window.event,{bbox:g.merge([],this._options.bbox)});if(d){this._refresh();this._refreshDrawing()}}},_toMap:function(b,c,a){c=c||this._center;a=a||this._pixelSize;var d=g.isArray(b[0]),e=d&&g.isArray(b[0][0]),f=e&&g.isArray(b[0][0][0]),l=this._contentBounds.width,m=this._contentBounds.height,n=l/2*a;a=m/2*a;c=[c[0]-n,c[1]-a,c[0]+n,c[1]+a];l=g.geo.width(c,true)/l;m=g.geo.height(c,
true)/m;a=this._options.axisLayout==="image";var t=[],u,w,B;if(!f){if(!e){d||(b=[b]);b=[b]}b=[b]}for(u=0;u<b.length;u++){t[u]=[];for(w=0;w<b[u].length;w++){t[u][w]=[];for(B=0;B<b[u][w].length;B++){n=b[u][w][B][1]*m;t[u][w][B]=[c[0]+b[u][w][B][0]*l,a?c[1]+n:c[3]-n]}}}return f?t:e?t[0]:d?t[0][0]:t[0][0][0]},_toPixel:function(b,c,a){c=c||this._center;a=a||this._pixelSize;var d=g.isArray(b[0]),e=d&&g.isArray(b[0][0]),f=e&&g.isArray(b[0][0][0]),l=this._contentBounds.width,m=this._contentBounds.height,
n=l/2*a;a=m/2*a;c=[c[0]-n,c[1]-a,c[0]+n,c[1]+a];var t=g.geo.width(c,true);a=g.geo.height(c,true);n=this._options.axisLayout==="image";l=l/t;m=m/a;a=[];var u,w;if(!f){if(!e){d||(b=[b]);b=[b]}b=[b]}for(t=0;t<b.length;t++){a[t]=[];for(u=0;u<b[t].length;u++){a[t][u]=[];for(w=0;w<b[t][u].length;w++)a[t][u][w]=[Math.round((b[t][u][w][0]-c[0])*l),Math.round((n?b[t][u][w][1]-c[1]:c[3]-b[t][u][w][1])*m)]}}return f?a:e?a[0]:d?a[0][0]:a[0][0][0]},_zoomTo:function(b,c,a,d){c=c<0?0:c;c=this._getPixelSize(c);this._setCenterAndSize(b,
...
b,{type:"LineString",coordinates:this._userGeodetic?g.geo.proj.toGeodetic(this._drawCoords):this._drawCoords})}else this._eventTarget_dblclick_zoom(b);this._resetDrawing();break;case "drawPolygon":case "measureArea":if(this._drawCoords.length>1&&!(this._drawCoords[0][0]==this._drawCoords[1][0]&&this._drawCoords[0][1]==this._drawCoords[1][1])){var c=this._drawCoords.length-1;if(c>2){this._drawCoords[c]=g.merge([],this._drawCoords[0]);this._trigger("shape",b,{type:"Polygon",coordinates:[this._userGeodetic?
g.geo.proj.toGeodetic(this._drawCoords):this._drawCoords]})}}else this._eventTarget_dblclick_zoom(b);this._resetDrawing();break;default:this._eventTarget_dblclick_zoom(b)}this._inOp=false}},_eventTarget_touchstart:function(b){if(this._options.mode!=="static")if(!(!this._supportTouch&&b.which!=1)){this._panFinalize();this._mouseWheelFinish();var c=g(b.currentTarget).offset(),a=b.originalEvent.changedTouches;if(this._supportTouch){this._multiTouchAnchor=g.merge([],a);if(this._isMultiTouch=this._multiTouchAnchor.length>
1){this._multiTouchCurrentBbox=[a[0].pageX-c.left,a[0].pageY-c.top,a[1].pageX-c.left,a[1].pageY-c.top];this._multiTouchAnchorBbox=g.merge([],this._multiTouchCurrentBbox);this._current=g.geo.center(this._multiTouchCurrentBbox,true)}else{this._multiTouchCurrentBbox=[a[0].pageX-c.left,a[0].pageY-c.top,NaN,NaN];this._current=[a[0].pageX-c.left,a[0].pageY-c.top]}}else this._current=[b.pageX-c.left,b.pageY-c.top];if(this._softDblClick){c=g.now();if(c-this._downDate<750){if(this._isTap){a=this._current[0]-
this._anchor[0];var d=this._current[1]-this._anchor[1];if(Math.sqrt(a*a+d*d)>8)this._isTap=false;else this._current=g.merge([],this._anchor)}this._isDbltap=this._isDbltap?false:this._isTap}else this._isDbltap=false;this._isTap=true;this._downDate=c}this._mouseDown=true;this._anchor=g.merge([],this._current);if(!this._inOp&&b.shiftKey){this._shiftZoom=true;this._$eventTarget.css("cursor",this._options.cursors.zoom)}else if(!this._isMultiTouch&&this._options.pannable){this._inOp=true;switch(this._options.mode){case "zoom":break;
default:this._lastDrag=this._current;b.currentTarget.setCapture&&b.currentTarget.setCapture()}}b.preventDefault();return false}},_dragTarget_touchmove:function(b){if(this._options.mode!=="static"){var c=this._$eventTarget.offset(),a=this._drawCoords.length,d=b.originalEvent.changedTouches,e;e=0;if(this._supportTouch){if(!this._isMultiTouch&&d[0].identifier!==this._multiTouchAnchor[0].identifier){this._mouseDown=false;this._dragTarget_touchstop(b);this._isMultiTouch=true;this._multiTouchAnchor.push(d[0]);
this._multiTouchCurrentBbox=[this._multiTouchCurrentBbox[0],this._multiTouchCurrentBbox[1],this._multiTouchAnchor[1].pageX-c.left,this._multiTouchAnchor[1].pageY-c.top];this._multiTouchAnchorBbox=g.merge([],this._multiTouchCurrentBbox);this._mouseDown=true;this._anchor=this._current=g.geo.center(this._multiTouchCurrentBbox,true);return false}if(this._isMultiTouch){for(;e<d.length;e++)if(d[e].identifier===this._multiTouchAnchor[0].identifier){this._multiTouchCurrentBbox[0]=d[e].pageX-c.left;this._multiTouchCurrentBbox[1]=
d[e].pageY-c.top}else if(d[e].identifier===this._multiTouchAnchor[1].identifier){this._multiTouchCurrentBbox[2]=d[e].pageX-c.left;this._multiTouchCurrentBbox[3]=d[e].pageY-c.top}g.geo.center(this._multiTouchCurrentBbox,true);e=this._multiTouchCurrentBbox[2]-this._multiTouchCurrentBbox[0];c=this._multiTouchAnchorBbox[2]-this._multiTouchAnchorBbox[0];this._wheelLevel=Math.abs(Math.floor((1-e/c)*10));if(Math.abs(e)<Math.abs(c))this._wheelLevel=-this._wheelLevel;d=this._getZoomCenterAndSize(this._anchor,
this._wheelLevel,false);this._$elem.find(".geo-shapes-container").geographics("clear");for(e=0;e<this._currentServices.length;e++){c=this._currentServices[e];g.geo._serviceTypes[c.type].interactiveScale(this,c,d.center,d.pixelSize)}this._graphicShapes.length>0&&this._graphicShapes.length<256&&this._refreshShapes(this._$shapesContainer,this._graphicShapes,this._graphicShapes,this._graphicShapes,d.center,d.pixelSize);if(this._drawCoords.length>0){this._drawPixels=this._toPixel(this._drawCoords,d.center,
d.pixelSize);this._refreshDrawing()}e=g.geo.center(this._multiTouchCurrentBbox,true)}else e=[b.originalEvent.changedTouches[0].pageX-c.left,b.originalEvent.changedTouches[0].pageY-c.top]}else e=[b.pageX-c.left,b.pageY-c.top];if(e[0]===this._lastMove[0]&&e[1]===this._lastMove[1])if(this._inOp){b.preventDefault();return false}if(r==7)this._isDbltap=this._isTap=false;if(this._mouseDown){this._current=e;this._moveDate=g.now()}if(this._isMultiTouch){b.preventDefault();return this._isDbltap=this._isTap=
false}switch(this._shiftZoom?"zoom":this._options.mode){case "zoom":if(this._mouseDown){this._$drawContainer.geographics("clear");this._$drawContainer.geographics("drawBbox",[this._anchor[0],this._anchor[1],e[0],e[1]])}else this._trigger("move",b,{type:"Point",coordinates:this.toMap(e)});break;case "drawLineString":case "drawPolygon":case "measureLength":case "measureArea":if(this._mouseDown||this._toolPan)this._panMove();else{if(a>0){this._drawCoords[a-1]=this._toMap(e);this._drawPixels[a-1]=e;this._refreshDrawing()}this._trigger("move",
b,{type:"Point",coordinates:this.toMap(e)})}break;default:this._mouseDown||this._toolPan?this._panMove():this._trigger("move",b,{type:"Point",coordinates:this.toMap(e)})}this._lastMove=e;if(this._inOp){b.preventDefault();return false}}},_dragTarget_touchstop:function(b){if(this._options.mode!=="static"){!this._mouseDown&&r==7&&this._eventTarget_touchstart(b);var c=this._mouseDown,a=this._toolPan,d=this._$eventTarget.offset(),e=this._shiftZoom?"zoom":this._options.mode,f,l;f=this._supportTouch?[b.originalEvent.changedTouches[0].pageX-
d.left,b.originalEvent.changedTouches[0].pageY-d.top]:[b.pageX-d.left,b.pageY-d.top];if(this._softDblClick)if(this._isTap){d=f[0]-this._anchor[0];l=f[1]-this._anchor[1];if(Math.sqrt(d*d+l*l)<=8)f=g.merge([],this._anchor)}d=f[0]-this._anchor[0];l=f[1]-this._anchor[1];this._$eventTarget.css("cursor",this._options.cursors[this._options.mode]);this._shiftZoom=this._mouseDown=this._toolPan=false;if(this._isMultiTouch){b.preventDefault();this._isMultiTouch=false;c=this._getZoomCenterAndSize(this._anchor,
this._wheelLevel,false);this._setCenterAndSize(c.center,c.pixelSize,true,true);this._wheelLevel=0;return false}document.releaseCapture&&document.releaseCapture();if(c){c=g.now();this._current=f;switch(e){case "zoom":if(d>0||l>0){a=this._pixelSize*6;e=this._toMap([[Math.min(this._anchor[0],f[0]),Math.max(this._anchor[1],f[1])],[Math.max(this._anchor[0],f[0]),Math.min(this._anchor[1],f[1])]]);e=[e[0][0],e[0][1],e[1][0],e[1][1]];if(e[2]-e[0]<a&&e[3]-e[1]<a)e=g.geo.scaleBy(this._getBbox(g.geo.center(e,
true)),0.5,true);this._setBbox(e,true,true)}this._resetDrawing();break;case "drawPoint":if(this._drawTimeout){window.clearTimeout(this._drawTimeout);this._drawTimeout=null}if(a)this._panFinalize();else if(c-this._clickDate>100){var m=this;this._drawTimeout=setTimeout(function(){if(m._drawTimeout){m._trigger("shape",b,{type:"Point",coordinates:m.toMap(f)});m._inOp=false;m._drawTimeout=null}},250)}break;case "drawLineString":case "drawPolygon":case "measureLength":case "measureArea":if(a)this._panFinalize();
else{a=this._drawCoords.length==0?0:this._drawCoords.length-1;this._drawCoords[a]=this._toMap(f);this._drawPixels[a]=f;if(a<2||!(this._drawCoords[a][0]==this._drawCoords[a-1][0]&&this._drawCoords[a][1]==this._drawCoords[a-1][1])){this._drawCoords[a+1]=this._toMap(f);this._drawPixels[a+1]=f}this._refreshDrawing()}break;default:if(a)this._panEnd();else if(c-this._clickDate>100){this._trigger("click",b,{type:"Point",coordinates:this.toMap(f)});this._inOp=false}}this._clickDate=c;if(this._softDblClick&&
...
c;a=this._getZoomCenterAndSize(this._anchor,this._wheelLevel,this._options.tilingScheme!=null);var d,e=0;for(this._$elem.find(".geo-shapes-container").geographics("clear");e<this._currentServices.length;e++){d=this._currentServices[e];g.geo._serviceTypes[d.type].interactiveScale(this,d,a.center,a.pixelSize)}this._graphicShapes.length>0&&this._graphicShapes.length<256&&this._refreshShapes(this._$shapesContainer,this._graphicShapes,this._graphicShapes,this._graphicShapes,a.center,a.pixelSize);if(this._drawCoords.length>
0){this._drawPixels=this._toPixel(this._drawCoords,a.center,a.pixelSize);this._refreshDrawing()}var f=this;this._wheelTimeout=window.setTimeout(function(){f._mouseWheelFinish()},1E3)}return false}}})})(jQuery);
...
b,c,a){var d=g.data(b,"geoServiceState");if(d){this._cancelUnloaded(r,b);d.serviceContainer.children().css("-moz-transition","").css({webkitTransition:"",transition:"",left:function(R,U){return parseInt(U)+c},top:function(R,U){return parseInt(U)+a}});if(b&&b.style.visibility==="visible"){var e=r._pixelSize,f=this,l=d.serviceContainer,m=l.children("[data-pixelSize='"+e+"']"),n=r._getContentBounds(),t=r.options.axisLayout==="image",u=t?+1:-1,w=r.options.tilingScheme,B=w.tileWidth,I=w.tileHeight,F=n.width/
2*e,y=n.height/2*e,K=m.position(),D=m.data("scaleOrigin").split(",");n=parseInt(D[0])-K.left;K=parseInt(D[1])-K.top;var J=r._getCenter();D=[J[0]+n*e,J[1]+u*K*e];var P=Math.floor((D[0]-F-w.origin[0])/(e*B));n=Math.max(Math.floor((t?D[1]-y-w.origin[1]:w.origin[1]-(D[1]+y))/(e*I)),0);K=Math.ceil((D[0]+F-w.origin[0])/(e*B));D=Math.ceil((t?D[1]+y-w.origin[1]:w.origin[1]-(D[1]-y))/(e*I));var H=r._getBboxMax(),C=r._getPixelSize(0),G=C/e,M=Math.floor((H[0]-w.origin[0])/(C*B))*G;H=Math.floor((w.origin[1]+
u*H[3])/(C*I))*G;C=w.origin[1]+u*H*I*e;F=Math.round((w.origin[0]+M*B*e-(J[0]-F))/e);t=Math.round((t?C-(J[1]-y):J[1]+y-C)/e);var z=b.style.opacity;for(y=P;y<K;y++)for(J=n;J<D;J++){P=""+y+","+J;var L=m.children("[data-tile='"+P+"']").removeAttr("data-dirty");if(L.size()===0){C=[w.origin[0]+y*B*e,w.origin[1]+u*J*I*e];G=[w.origin[0]+((y+1)*B-1)*e,w.origin[1]+u*((J+1)*I-1)*e];G=[C[0],C[1],G[0],G[1]];C=b.hasOwnProperty("src")?"src":"getUrl";G={bbox:G,width:B,height:I,zoom:r._getZoom(),tile:{row:J,column:y},
...
q)z+="width: 100%; height: 100%;";z+="margin:0; padding:0; -khtml-user-select:none; -moz-user-select:none; -webkit-user-select:none; user-select:none; display:none;' unselectable='on' data-tile='"+K+"' />";l.append(z);M=l.children(":last")}typeof D==="string"?e._loadImage(M,D,d,c,f,G):D.done(function(L){e._loadImage(M,L,d,c,f,G)}).fail(function(){M.remove();c.loadCount--})}}a.find("[data-dirty]").remove();c.reloadTiles=false}},resize:function(){},opacity:function(r,b){g.data(b,"geoServiceState").serviceContainer.find("img").stop(true).fadeTo("fast",
b.style.opacity)},toggle:function(r,b){g.data(b,"geoServiceState").serviceContainer.css("display",b.style.visibility==="visible"?"block":"none")},_cancelUnloaded:function(r,b){var c=g.data(b,"geoServiceState");if(c&&c.loadCount>0)for(c.serviceContainer.find("img:hidden").remove();c.loadCount>0;)c.loadCount--},_loadImage:function(r,b,c,a,d,e){r.load(function(f){e<1?g(f.target).fadeTo(0,e):g(f.target).show();a.loadCount--;if(a.loadCount<=0){d.children(":not([data-pixelSize='"+c+"'])").remove();a.loadCount=
0}}).error(function(f){g(f.target).remove();a.loadCount--;if(a.loadCount<=0){d.children(":not([data-pixelSize='"+c+"'])").remove();a.loadCount=0}}).attr("src",b)}}}()})(jQuery);
...
r,b,c){var a=g.data(r,"geoServiceState");if(a){this._cancelUnloaded(q,r);r=a.serviceContainer;q=q._pixelSize;a=r.children("[data-pixelSize='"+q+"']");var d=a.children("div");if(!d.length){a.children("img").wrap('<div style="position:absolute; left:0; top:0; width:100%; height:100%;"></div>');d=a.children("div")}d.css({left:function(e,f){return parseInt(f)+b},top:function(e,f){return parseInt(f)+c}});r.children(":not([data-pixelSize='"+q+"'])").remove()}},interactiveScale:function(q,r,b,c){var a=g.data(r,
"geoServiceState");if(a){this._cancelUnloaded(q,r);r=a.serviceContainer;q=q._getContentBounds();var d=q.width,e=q.height,f=d/2,l=e/2;r.children().each(function(){var m=g(this),n=m.attr("data-pixelSize"),t=n/c;m.css({width:d*t,height:e*t}).children("img").each(function(){var u=g(this),w=u.data("center");u.css({left:(Math.round((w[0]-b[0])/n)-f)*t+"px",top:(Math.round((b[1]-w[1])/n)-l)*t+"px"})})})}},refresh:function(q,r){var b=g.data(r,"geoServiceState");this._cancelUnloaded(q,r);if(b&&r&&r.style.visibility===
"visible"&&!b.serviceContainer.is(":hidden")){var c=q._getBbox(),a=q._pixelSize,d=this,e=b.serviceContainer,f=q._getContentBounds(),l=f.width,m=f.height,n=l/2,t=m/2;f=e.children('[data-pixelSize="'+a+'"]');var u=r.style.opacity,w;if(!f.size()){e.append('<div style="position:absolute; left:'+n+"px; top:"+t+"px; width:"+l+"px; height:"+m+'px; margin:0; padding:0;" data-pixelSize="'+a+'"></div>');f=e.children(":last")}f.children("img").each(function(){var I=g(this),F=I.data("center"),y=q._getCenter();
I.css({left:Math.round((F[0]-y[0])/a)-n+"px",top:Math.round((y[1]-F[1])/a)-t+"px"})});u<1&&e.find("img").attr("data-keepAlive","0");var B=r.hasOwnProperty("src")?"src":"getUrl";c={bbox:c,width:l,height:m,zoom:q._getZoom(),tile:null,index:0};if(g.isFunction(r[B]))c=r[B](c);else{g.template("geoSrc",r[B]);c=g.render(c,"geoSrc")}b.loadCount++;f.append('<img style="position:absolute; left:-'+n+"px; top:-"+t+'px; width:100%; height:100%; margin:0; padding:0; -khtml-user-select:none; -moz-user-select:none; -webkit-user-select:none; user-select:none; display:none;" unselectable="on" />');
w=f.children(":last").data("center",q._getCenter());typeof c==="string"?d._loadImage(w,c,a,b,e,u):c.done(function(I){d._loadImage(w,I,a,b,e,u)}).fail(function(){w.remove();b.loadCount--})}},resize:function(q,r){var b=g.data(r,"geoServiceState");if(b&&r&&r.style.visibility==="visible"){this._cancelUnloaded(q,r);var c=b.serviceContainer,a=q._getContentBounds();b=a.width/2;a=a.height/2;c=c.children();c.attr("data-pixelSize","0");c.css({left:b+"px",top:a+"px"})}},opacity:function(q,r){g.data(r,"geoServiceState").serviceContainer.find("img").stop(true).fadeTo("fast",
r.style.opacity)},toggle:function(q,r){g.data(r,"geoServiceState").serviceContainer.css("display",r.style.visibility==="visible"?"block":"none")},_cancelUnloaded:function(q,r){var b=g.data(r,"geoServiceState");if(b&&b.loadCount>0)for(b.serviceContainer.find("img:hidden").remove();b.loadCount>0;)b.loadCount--},_loadImage:function(q,r,b,c,a,d){q.load(function(e){d<1?g(e.target).fadeTo(0,d):g(e.target).show();c.loadCount--;if(c.loadCount<=0){a.children(':not([data-pixelSize="'+b+'"])').remove();e=a.find('[data-pixelSize="'+
b+'"]>div');if(e.size()>0){var f=e.position();e.children("img").each(function(){var l=g(this),m=f.left+parseInt(l.css("left")),n=f.top+parseInt(l.css("top"));l.css({left:m+"px",top:n+"px"})}).unwrap();e.remove()}c.loadCount=0}}).error(function(e){g(e.target).remove();c.loadCount--;if(c.loadCount<=0){a.children(":not([data-pixelSize='"+b+"'])").remove();c.loadCount=0}}).attr("src",r)}}}()})(jQuery);
