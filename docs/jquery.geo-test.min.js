...
l*l);else for(var o=1;o<b.length;o++){var t=b[o],s=d[0]-t[0],v=d[1]-t[1];e=this._distanceSegmentPoint(t[0]-e[0],t[1]-e[1],p,l,s,v);if(e==0)return 0;if(e<g)g=e;e=t;p=s;l=v}}return Math.sqrt(g)},_distanceSegmentPoint:function(b,d,g,e,p,l){var o=b*g+d*e;if(o<=0)return g*g+e*e;b=b*b+d*d;if(o>=b)return p*p+l*l;return g*g+e*e-o*o/b},_distanceLineStringLineString:function(b,d){for(var g=a,e=0;e<d.length;e++)g=Math.min(g,this._distanceLineStringPoint(b,d[e]));return g},_buffer:function(b,d,g){switch(b.type){case "Point":b=
...
case "Polygon":e=!d&&f.geo.proj?f.geo.proj.fromGeodetic(b.coordinates[0]):b.coordinates[0]}if(e){for(;p<=e.length;p++){l=p%e.length;g+=(e[p-1][0]-e[l][0])*(e[p-1][1]+e[l][1])/2}return Math.abs(g)}},pointAlong:function(b,d,g){var e=0,p=0,l=0,o,t=[],s=1,v;switch(b.type){case "Point":return f.extend({},b);case "LineString":o=b.coordinates;break;case "Polygon":o=b.coordinates[0]}if(o)if(d===0)return{type:"Point",coordinates:[o[0][0],o[0][1]]};else if(d===1){s=o.length-1;return{type:"Point",coordinates:[o[s][0],
...
0)g[1]+=c;this._$measureLabel.css({left:g[0],top:g[1]}).show()}}},_resetDrawing:function(){this._drawPixels=[];this._drawCoords=[];this._$drawContainer.geographics("clear");this._$measureLabel.hide()},_refreshShapes:function(a,c,b,d,g,e){var p,l,o,t,s,v,A,H=this._getBbox(g,e);for(p=0;p<c.length;p++){o=c[p].shape||c[p];o=o.geometry||o;l=f.data(o,"geoBbox");if(!(l&&f.geo._bboxDisjoint(H,l))){t=f.isArray(b)?b[p].style:b;s=f.isArray(d)?d[p].label:d;v=s!==w;A=w;switch(o.type){case "Point":A=this.toPixel(o.coordinates,
g,e);this._$shapesContainer.geographics("drawPoint",A,t);break;case "LineString":this._$shapesContainer.geographics("drawLineString",this.toPixel(o.coordinates,g,e),t);if(v)A=this.toPixel(f.geo.pointAlong(o,0.5).coordinates,g,e);break;case "Polygon":this._$shapesContainer.geographics("drawPolygon",this.toPixel(o.coordinates,g,e),t);if(v)A=this.toPixel(f.geo.centroid(o).coordinates,g,e);break;case "MultiPoint":for(l=0;l<o.coordinates.length;l++)this._$shapesContainer.geographics("drawPoint",this.toPixel(o.coordinates[l],
g,e),t);if(v)A=this.toPixel(f.geo.centroid(o).coordinates,g,e);break;case "MultiLineString":for(l=0;l<o.coordinates.length;l++)this._$shapesContainer.geographics("drawLineString",this.toPixel(o.coordinates[l],g,e),t);if(v)A=this.toPixel(f.geo.centroid(o).coordinates,g,e);break;case "MultiPolygon":for(l=0;l<o.coordinates.length;l++)this._$shapesContainer.geographics("drawPolygon",this.toPixel(o.coordinates[l],g,e),t);if(v)A=this.toPixel(f.geo.centroid(o).coordinates,g,e);break;case "GeometryCollection":this._refreshShapes(a,
o.geometries,t,s,g,e)}v&&A&&this._$labelsContainer.append('<div class="geo-label" style="position:absolute; left:'+A[0]+"px; top:"+A[1]+'px;">'+s+"</div>")}}},_findMapSize:function(){for(var a={width:0,height:0},c=this._$elem;c.size()&&!(a.width>0&&a.height>0);){a={width:c.width(),height:c.height()};if(a.width<=0||a.height<=0)a={width:parseInt(c.css("width")),height:parseInt(c.css("height"))};c=c.parent()}return a},_forcePosition:function(a){var c=a.css("position");c!="relative"&&c!="absolute"&&c!=
...
c,b){c=c||this._center;b=b||this._pixelSize;var d=f.isArray(a[0]),g=d&&f.isArray(a[0][0]),e=g&&f.isArray(a[0][0][0]),p=this._contentBounds.width,l=this._contentBounds.height,o=p/2*b;b=l/2*b;c=[c[0]-o,c[1]-b,c[0]+o,c[1]+b];p=f.geo.width(c,true)/p;l=f.geo.height(c,true)/l;b=this._options.axisLayout==="image";var t=[],s,v,A;if(!e){if(!g){d||(a=[a]);a=[a]}a=[a]}for(s=0;s<a.length;s++){t[s]=[];for(v=0;v<a[s].length;v++){t[s][v]=[];for(A=0;A<a[s][v].length;A++){o=a[s][v][A][1]*l;t[s][v][A]=[c[0]+a[s][v][A][0]*
p,b?c[1]+o:c[3]-o]}}}return e?t:g?t[0]:d?t[0][0]:t[0][0][0]},_toPixel:function(a,c,b){c=c||this._center;b=b||this._pixelSize;var d=f.isArray(a[0]),g=d&&f.isArray(a[0][0]),e=g&&f.isArray(a[0][0][0]),p=this._contentBounds.width,l=this._contentBounds.height,o=p/2*b;b=l/2*b;c=[c[0]-o,c[1]-b,c[0]+o,c[1]+b];var t=f.geo.width(c,true);b=f.geo.height(c,true);o=this._options.axisLayout==="image";p=p/t;l=l/b;b=[];var s,v;if(!e){if(!g){d||(a=[a]);a=[a]}a=[a]}for(t=0;t<a.length;t++){b[t]=[];for(s=0;s<a[t].length;s++){b[t][s]=
[];for(v=0;v<a[t][s].length;v++)b[t][s][v]=[Math.round((a[t][s][v][0]-c[0])*p),Math.round((o?a[t][s][v][1]-c[1]:c[3]-a[t][s][v][1])*l)]}}return e?b:g?b[0]:d?b[0][0]:b[0][0][0]},_zoomTo:function(a,c,b,d){c=c<0?0:c;var g=this._getTiledPixelSize(c);if(isNaN(g)){c=f.geo._scaleBy(this._getBboxMax(),1/Math.pow(this._zoomFactor,c),true);c=Math.max(f.geo.width(c,true)/this._contentBounds.width,f.geo.height(c,true)/this._contentBounds.height);this._setCenterAndSize(a,c,b,d)}else this._setCenterAndSize(a,g,
