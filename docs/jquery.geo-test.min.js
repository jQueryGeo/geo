...
this).geomap();b.attr&&this._$attrList.append("<li>"+b.attr+"</li>")}this._$attrList.find("a").css({position:"relative",zIndex:100})},_refreshDrawing:function(){this._$drawContainer.geographics("clear");if(this._drawPixels.length>0){var b=this._options.mode,a=this._drawPixels,c=this._drawCoords,e,d;switch(b){case "measureLength":b="drawLineString";d={type:"LineString",coordinates:c};e=f.render({length:f.geo.length(d,true)},"geoMeasureLength");d=f.merge([],a[a.length-1]);break;case "measureArea":b=
"drawPolygon";d={type:"Polygon",coordinates:[f.merge([],c)]};d.coordinates[0].push(c[0]);e=f.render({area:f.geo.area(d,true)},"geoMeasureArea");d=f.merge([],a[a.length-1]);a=[a];break;case "drawPolygon":a=[a]}this._$drawContainer.geographics(b,a);if(e){this._$measureLabel.html(e);b=this._contentBounds.width-(this._$measureLabel.outerWidth(true)+d[0]);a=this._contentBounds.height-(this._$measureLabel.outerHeight(true)+d[1]);if(b<0)d[0]+=b;if(a<0)d[1]+=a;this._$measureLabel.css({left:d[0],top:d[1]}).show()}}},
