...
h.clientWidth+"px";h.firstChild.style.height=h.clientHeight+"px"}}function c(){return[[1,0,0],[0,1,0],[0,0,1]]}function d(h,l){for(var o=c(),s=0;s<3;s++)for(var w=0;w<3;w++){for(var t=0,K=0;K<3;K++)t+=h[s][K]*l[K][w];o[s][w]=t}return o}function e(h,l){l.fillStyle=h.fillStyle;l.lineCap=h.lineCap;l.lineJoin=h.lineJoin;l.lineWidth=h.lineWidth;l.miterLimit=h.miterLimit;l.shadowBlur=h.shadowBlur;l.shadowColor=h.shadowColor;l.shadowOffsetX=h.shadowOffsetX;l.shadowOffsetY=h.shadowOffsetY;l.strokeStyle=h.strokeStyle;
...
$.widget||function(f,p){var q=Array.prototype.slice,a=f.cleanData;f.cleanData=function(b){for(var c=0,d;(d=b[c])!=null;c++)f(d).triggerHandler("remove");a(b)};f.widget=function(b,c,d){var e=b.split(".")[0],k;b=b.split(".")[1];k=e+"-"+b;if(!d){d=c;c=f.Widget}f.expr[":"][k]=function(j){return!!f.data(j,b)};f[e]=f[e]||{};f[e][b]=f.extend(function(j,m){if(!this._createWidget)return new f[e][b](j,m);arguments.length&&this._createWidget(j,m)},f[e][b]);var g=new c;g.options=f.extend(true,{},g.options);f.each(d,
function(j,m){if(f.isFunction(m))d[j]=function(){var n=function(u){return c.prototype[u].apply(this,q.call(arguments,1))},v=function(u,z){return c.prototype[u].apply(this,z)};return function(){var u=this._super,z=this._superApply,A;this._super=n;this._superApply=v;A=m.apply(this,arguments);this._super=u;this._superApply=z;return A}}()});f[e][b].prototype=f.extend(true,g,{namespace:e,widgetName:b,widgetEventPrefix:b,widgetBaseClass:k},d);f.widget.bridge(b,f[e][b])};f.widget.bridge=function(b,c){f.fn[b]=
function(d){var e=typeof d==="string",k=q.call(arguments,1),g=this;d=!e&&k.length?f.extend.apply(null,[true,d].concat(k)):d;e?this.each(function(){var j=f.data(this,b);if(!j)return f.error("cannot call methods on "+b+" prior to initialization; attempted to call method '"+d+"'");if(!f.isFunction(j[d])||d.charAt(0)==="_")return f.error("no such method '"+d+"' for "+b+" widget instance");var m=j[d].apply(j,k);if(m!==j&&m!==p){g=m;return false}}):this.each(function(){var j=f.data(this,b);j?j.option(d||
...
0:this._distanceLineStringLineString(c[0],d[0]);default:throw Error("not implemented");}}},_distancePointPoint:function(a,b){var c=b[0]-a[0],d=b[1]-a[1];return Math.sqrt(c*c+d*d)},_distanceLineStringPoint:function(a,b){var c=p;if(a.length>0){var d=a[0],e=b[0]-d[0],k=b[1]-d[1];if(a.length==1)return Math.sqrt(e*e+k*k);else for(var g=1;g<a.length;g++){var j=a[g],m=b[0]-j[0],n=b[1]-j[1];d=this._distanceSegmentPoint(j[0]-d[0],j[1]-d[1],e,k,m,n);if(d==0)return 0;if(d<c)c=d;d=j;e=m;k=n}}return Math.sqrt(c)},
_distanceSegmentPoint:function(a,b,c,d,e,k){var g=a*c+b*d;if(g<=0)return c*c+d*d;a=a*a+b*b;if(g>=a)return e*e+k*k;return c*c+d*d-g*g/a},_distanceLineStringLineString:function(a,b){for(var c=p,d=0;d<b;d++)c=Math.min(c,this._distanceLineStringPoint(a,b[d]));return c},_flatten:function(a){var b=[];switch(a.type){case "Feature":f.merge(b,this._flatten(a.geometry));break;case "GeometryCollection":for(curGeom=0;curGeom<a.geometries.length;curGeom++)f.merge(b,this._flatten(a.geometries[curGeom]));break;
default:b[0]=a}return b},_WKT:function(){function a(d){if(d&&d.length){for(var e=[],k=0;k<d.length;k++)e.push(d[k].join(" "));return"("+e+")"}else return"EMPTY"}function b(d){if(d&&d.length){for(var e=[],k=0;k<d.length;k++)e.push(a(d[k]));return"("+e+")"}else return"EMTPY"}function c(d){if(d&&d.type)switch(d.type){case "Point":return"POINT "+(d.coordinates&&d.coordinates.length?"("+d.coordinates.join(" ")+")":"EMPTY");case "LineString":return"LINESTRING "+a(d.coordinates);case "Polygon":return"POLYGON "+
b(d.coordinates);case "MultiPoint":return"MULTIPOINT "+a(d.coordinates);case "MultiLineString":return"MULTILINSTRING "+b(d.coordinates);case "MultiPolygon":if((d=d.coordinates)&&d.length){for(var e=[],k=0;k<d.length;k++)e.push(b(d[k]));d="("+e+")"}else d="EMPTY";return"MULTIPOLYGON "+d;case "GeometryCollection":if((d=d.geometries)&&d.length){e=[];for(k=0;k<d.length;k++)e.push(c(d[k]));d="("+d+")"}else d="EMPTY";return"GEOMETRYCOLLECTION "+d;default:return""}else return""}return{stringify:c,parse:function(d){d=
f.trim(d);var e=d.indexOf(" ");switch(d.substr(0,e).toUpperCase()){case "POINT":return(d=d.substr(e+1).match(/\(\s*([\d\.-]+)\s+([\d\.-]+)\s*\)/))&&d.length>=2?{type:"Point",coordinates:[parseFloat(d[1]),parseFloat(d[2])]}:null}}}}(),proj:function(){return{fromGeodeticPos:function(a){return[6378137*a[0]*0.017453292519943295,6378137*Math.log(Math.tan(0.7853981633974483+a[1]*0.017453292519943295/2))]},fromGeodetic:function(a){var b=f.isArray(a[0]),c=this.fromGeodeticPos;if(!b&&a.length==4){b=c([a[0],
a[1]]);a=c([a[2],a[3]]);return[b[0],b[1],a[0],a[1]]}else{var d=b&&f.isArray(a[0][0]),e=d&&f.isArray(a[0][0][0]),k=[[[]]];if(!e){if(!d){b||(a=[a]);a=[a]}a=[a]}f.each(a,function(g){f.each(this,function(j){f.each(this,function(m){k[g][j][m]=c(this)})})});return e?k:d?k[0]:b?k[0][0]:k[0][0][0]}},toGeodeticPos:function(a){return[a[0]/6378137*57.29577951308232,(1.5707963267948966-2*Math.atan(1/Math.exp(a[1]/6378137)))*57.29577951308232]},toGeodetic:function(a){var b=f.isArray(a[0]),c=this.toGeodeticPos;
if(!b&&a.length==4){b=c([a[0],a[1]]);a=c([a[2],a[3]]);return[b[0],b[1],a[0],a[1]]}else{var d=b&&f.isArray(a[0][0]),e=d&&f.isArray(a[0][0][0]),k=[[[]]];if(!e){if(!d){b||(a=[a]);a=[a]}a=[a]}f.each(a,function(g){f.each(this,function(j){f.each(this,function(m){k[g][j][m]=c(this)})})});return e?k:d?k[0]:b?k[0][0]:k[0][0][0]}}}}(),_serviceTypes:{}}})(jQuery,this);
(function(f){var p,q,a=true,b,c,d,e,k=function(){for(var g=5,j=document.createElement("div"),m=j.all||[];j.innerHTML="<!--[if gt IE "+ ++g+"]><br><![endif]--\>",m[0];);return g>6?g:!g}();f.widget("geo.geographics",{options:{style:{borderRadius:"8px",color:"#7f0000",fillOpacity:0.2,height:"8px",opacity:1,strokeOpacity:1,strokeWidth:"2px",visibility:"visible",width:"8px"}},_create:function(){p=this.element;q=this.options;p.css({display:"inline-block",overflow:"hidden",textAlign:"left"});p.css("position")==
"static"&&p.css("position","relative");b=p.width();c=p.height();if(!(b&&c)){b=parseInt(p.css("width"));c=parseInt(p.css("height"))}if(document.createElement("canvas").getContext){p.append('<canvas width="'+b+'" height="'+c+'" style="position:absolute; left:0; top:0; width:'+b+"px; height:"+c+'px;"></canvas>');d=p.children(":last");e=d[0].getContext("2d")}else if(k<=8){a=false;p.append('<div width="'+b+'" height="'+c+'" style="position:absolute; left:0; top:0; width:'+b+"px; height:"+c+'px; margin:0; padding:0;"></div>');
...
(function(f,p){var q=function(){for(var a=5,b=document.createElement("div"),c=b.all||[];b.innerHTML="<!--[if gt IE "+ ++a+"]><br><![endif]--\>",c[0];);return a>6?a:!a}();f.widget("geo.geomap",{_$elem:p,_created:false,_contentBounds:{},_$contentFrame:p,_$existingChildren:p,_$servicesContainer:p,_$shapesContainer:p,_$textContainer:p,_$textContent:p,_$eventTarget:p,_dpi:96,_currentServices:[],_center:p,_pixelSize:p,_centerMax:p,_pixelSizeMax:p,_wheelZoomFactor:1.18920711500273,_wheelTimer:null,_wheelLevel:0,
...
this._clickDate=0}f.Widget.prototype._createWidget.apply(this,arguments)},_create:function(){if(!this._$elem.is("[data-geo-service]")){this._options=this.options;this._softDblClick=(this._supportTouch="ontouchend"in document)||q==7;var a=this._supportTouch?"touchstart":"mousedown",b=this._supportTouch?"touchend touchcancel":"mouseup",c=this._supportTouch?"touchmove":"mousemove";this._$eventTarget.dblclick(f.proxy(this._eventTarget_dblclick,this));this._$eventTarget.bind(a,f.proxy(this._eventTarget_touchstart,
this));a=this._$eventTarget[0].setCapture?this._$eventTarget:f(document);a.bind(c,f.proxy(this._dragTarget_touchmove,this));a.bind(b,f.proxy(this._dragTarget_touchstop,this));this._$eventTarget.mousewheel(f.proxy(this._eventTarget_mousewheel,this));var d=this;this._windowHandler=function(){d._timeoutResize&&clearTimeout(d._timeoutResize);this._timeoutResize=setTimeout(function(){d._created&&d._$elem.geomap("resize")},500)};f(window).resize(this._windowHandler);this._$shapesContainer.geographics();
if(this._initOptions){this._initOptions.bbox&&this._setOption("bbox",this._initOptions.bbox,false);this._initOptions.center&&this._setOption("center",this._initOptions.center,false);this._initOptions.zoom&&this._setZoom(this._initOptions.zoom,false,false)}this._$eventTarget.css("cursor",this._options.cursors[this._options.mode]);this._createServices();this._refresh();this._created=true}},_setOption:function(a,b,c){if(!this._$elem.is("[data-geo-service]")){c=c===p||c;switch(a){case "bbox":if(f.geo.proj){b=
f.geo.proj.fromGeodetic([[b[0],b[1]],[b[2],b[3]]]);b=[b[0][0],b[0][1],b[1][0],b[1][1]]}this._setBbox(b,false,c);b=this._getBbox();if(f.geo.proj){b=f.geo.proj.toGeodetic([[b[0],b[1]],[b[2],b[3]]]);b=[b[0][0],b[0][1],b[1][0],b[1][1]]}break;case "center":this._setCenterAndSize(f.geo.proj?f.geo.proj.fromGeodetic([[b[0],b[1]]])[0]:b,this._pixelSize,false,c);break;case "zoom":this._setZoom(b,false,c)}f.Widget.prototype._setOption.apply(this,arguments);switch(a){case "services":this._createServices();c&&
this._refresh()}}},destroy:function(){if(this._$elem.is("[data-geo-map]")){this._created=false;f(window).unbind("resize",this._windowHandler);for(var a=0;a<this._currentServices.length;a++){this._currentServices[a].serviceContainer.geomap("destroy");f.geo._serviceTypes[this._currentServices[a].type].destroy(this,this._$servicesContainer,this._currentServices[a])}this._$shapesContainer.geographics("destroy");this._$existingChildren.detach();this._$elem.html("");this._$elem.append(this._$existingChildren);
this._$elem.removeAttr("data-geo-map")}f.Widget.prototype.destroy.apply(this,arguments)},getPixelSize:function(){return this._pixelSize},toMap:function(a){a=this._toMap(a);return f.geo.proj?f.geo.proj.toGeodetic(a):a},toPixel:function(a){a=f.geo.proj?f.geo.proj.fromGeodetic(a):a;return this._toPixel(a)},opacity:function(a,b){if(this._$elem.is("[data-geo-service]"))this._$elem.closest("[data-geo-map]").geomap("opacity",a,this._$elem);else if(a>=0||a<=1)for(var c=0;c<this._currentServices.length;c++){var d=
this._currentServices[c];if(!b||d.serviceContainer[0]==b[0]){this._options.services[c].opacity=d.opacity=a;f.geo._serviceTypes[d.type].opacity(this,d)}}},toggle:function(a,b){if(this._$elem.is("[data-geo-service]"))this._$elem.closest("[data-geo-map]").geomap("toggle",a,this._$elem);else for(var c=0;c<this._currentServices.length;c++){var d=this._currentServices[c];if(!b||d.serviceContainer[0]==b[0]){if(a===p)a=d.visible===p?false:!d.visible;this._options.services[c].visible=d.visible=a;f.geo._serviceTypes[d.type].toggle(this,
d);a&&f.geo._serviceTypes[d.type].refresh(this,d)}}},zoom:function(a){a!=null&&this._setZoom(this._options.zoom+a,false,true)},refresh:function(){this._refresh()},resize:function(){var a=this._findMapSize();this._contentBounds={x:parseInt(this._$elem.css("padding-left")),y:parseInt(this._$elem.css("padding-top")),width:a.width,height:a.height};this._$contentFrame.css({width:a.width,height:a.height});this._$servicesContainer.css({width:a.width,height:a.height});this._$eventTarget.css({width:a.width,
height:a.height});this._$shapesContainer.geographics("destroy");this._$shapesContainer.css({width:a.width,height:a.height});this._$shapesContainer.geographics();this._setCenterAndSize(this._center,this._pixelSize,false,true)},shapeStyle:function(a){if(a){this._$shapesContainer.geographics("option","style",a);this._refresh()}else return this._$shapesContainer.geographics("option","style")},append:function(a,b,c){c=c===p||c;if(a){var d=this;a=a.type=="FeatureCollection"?a.features:f.isArray(a)?a:[a];
f.each(a,function(){d._graphicShapes[d._graphicShapes.length]={shape:this,style:b}});c&&this._refresh()}},empty:function(){this._graphicShapes=[];this._refresh()},find:function(a,b){this.toPixel(a.coordinates);var c=this._pixelSize*b,d=[],e;f.each(this._graphicShapes,function(){if(this.shape.type=="Point")f.geo._distance(this.shape,a)<=c&&d.push(this.shape);else{var k=f.geo.bbox(this.shape);if(f.geo._distance({type:"Polygon",coordinates:[[[k[0],k[1]],[k[0],k[3]],[k[2],k[3]],[k[2],k[1]],[k[0],k[1]]]]},
a)<=c){k=f.geo._flatten(this.shape);for(e=0;e<k.length;e++)if(f.geo._distance(k[e],a)<=c){d.push(this.shape);break}}}});return d},remove:function(a){var b=this;f.each(this._graphicShapes,function(c){if(this.shape==a){var d=b._graphicShapes.slice(c+1||b._graphicShapes.length);b._graphicShapes.length=c<0?b._graphicShapes.length+c:c;b._graphicShapes.push.apply(b._graphicShapes,d);return false}});this._refresh()},_getBbox:function(){var a=this._contentBounds.width/2*this._pixelSize,b=this._contentBounds.height/
...
f.extend({},this._options.services[a]);this._currentServices[a].serviceContainer=f.geo._serviceTypes[this._currentServices[a].type].create(this,this._$servicesContainer,this._currentServices[a],a).geomap()}},_drawGraphics:function(a,b,c){var d,e,k,g,j,m=this;for(d=0;d<b.length;d++){k=b[d].shape||b[d];k=k.geometry||k;g=f.isArray(c)?c[d].style:c;switch(k.type){case "Point":this._$shapesContainer.geographics("drawPoint",this.toPixel(k.coordinates),g);break;case "LineString":this._$shapesContainer.geographics("drawLineString",
this.toPixel(k.coordinates),g);break;case "Polygon":j=[];f.each(k.coordinates,function(n){j[n]=m.toPixel(this)});this._$shapesContainer.geographics("drawPolygon",j,g);break;case "MultiPoint":for(e=0;e<k.coordinates;e++)this._$shapesContainer.geographics("drawPoint",this.toPixel(k.coordinates[e]),g);break;case "MultiLineString":for(e=0;e<k.coordinates;e++)this._$shapesContainer.geographics("drawLineString",this.toPixel(k.coordinates[e]),g);break;case "MultiPolygon":for(e=0;e<k.coordinates;e++){j=[];
f.each(k.coordinates[e],function(n){j[n]=m.toPixel(this)});this._$shapesContainer.geographics("drawPolygon",j,g)}break;case "GeometryCollection":m._drawGraphics(a,k.geometries,g)}}},_findMapSize:function(){for(var a={width:0,height:0},b=this._$elem;b.size()&&!(a.width>0&&a.height>0);){a={width:b.width(),height:b.height()};if(a.width<=0||a.height<=0)a={width:parseInt(b.css("width")),height:parseInt(b.css("height"))};b=b.parent()}return a},_forcePosition:function(a){var b=a.css("position");b!="relative"&&
...
b,c,d){if(q[b.id]){this._cancelUnloaded(a,b);q[b.id].serviceContainer.children().css({left:function(I,L){return parseInt(L)+c},top:function(I,L){return parseInt(L)+d}});if(b&&q[b.id]!=null&&(b.visible===p||b.visible)){var e=a.getPixelSize(),k=q[b.id],g=k.serviceContainer,j=g.children("[data-pixelSize='"+e+"']"),m=a._getContentBounds(),n=a.options.tilingScheme,v=n.tileWidth,u=n.tileHeight,z=m.width/2*e,A=m.height/2*e,y=j.position(),x=j.data("scaleOrigin").split(",");m=parseInt(x[0])-y.left;y=parseInt(x[1])-
...
x+"' />";A.append(D);D=A.children(":last");D.load(function(r){B<1?f(r.target).fadeTo(0,B):f(r.target).show();e.loadCount--;if(e.loadCount<=0){k.children(":not([data-pixelSize='"+d+"'])").remove();e.loadCount=0}}).error(function(r){f(r.target).remove();e.loadCount--;if(e.loadCount<=0){k.children(":not([data-pixelSize='"+d+"'])").remove();e.loadCount=0}}).attr("src",J)}}}c.find("[data-dirty]").remove();e.reloadTiles=false}},opacity:function(a,b){q[b.id].serviceContainer.find("img").stop(true).fadeTo("fast",
...
b);b=q[b.id].serviceContainer;a=a.getPixelSize();a=b.children("[data-pixelSize='"+a+"']");b=a.children("div");if(!b.length){a.children("img").wrap('<div style="position:absolute; left:0; top:0; width:100%; height:100%;"></div>');b=a.children("div")}b.css({left:function(e,k){return parseInt(k)+c},top:function(e,k){return parseInt(k)+d}})}},interactiveScale:function(a,b,c,d){if(q[b.id]){this._cancelUnloaded(a,b);b=q[b.id].serviceContainer;a=a._getContentBounds();var e=a.width,k=a.height,g=e/2,j=k/2;
b.children().each(function(){var m=f(this),n=m.attr("data-pixelSize"),v=n/d;m.css({width:e*v,height:k*v}).children("img").each(function(){var u=f(this),z=u.data("center");u.css({left:(Math.round((z[0]-c[0])/n)-g)*v+"px",top:(Math.round((c[1]-z[1])/n)-j)*v+"px"})})})}},refresh:function(a,b){if(b&&q[b.id]&&(b.visible===p||b.visible)){this._cancelUnloaded(a,b);var c=a._getBbox(),d=a.getPixelSize(),e=q[b.id],k=e.serviceContainer,g=a._getContentBounds(),j=g.width,m=g.height,n=j/2,v=m/2;g=k.children('[data-pixelSize="'+
d+'"]');var u=b.opacity===p?1:b.opacity;if(!g.size()){k.append('<div style="position:absolute; left:'+n+"px; top:"+v+"px; width:"+j+"px; height:"+m+'px; margin:0; padding:0;" data-pixelSize="'+d+'"></div>');g=k.children(":last")}g.children("img").each(function(){var z=f(this),A=z.data("center"),y=a._getCenter();z.css({left:Math.round((A[0]-y[0])/d)-n+"px",top:Math.round((y[1]-A[1])/d)-v+"px"})});u<1&&k.find("img").attr("data-keepAlive","0");c=b.getUrl({bbox:c,width:j,height:m,zoom:a._getZoom(),tile:null,
index:0});e.loadCount++;g.append('<img style="position:absolute; left:-'+n+"px; top:-"+v+'px; width:100%; height:100%; margin:0; padding:0; -khtml-user-select:none; -moz-user-select:none; -webkit-user-select:none; user-select:none; display:none;" unselectable="on" />');g.children(":last").data("center",a._getCenter()).load(function(z){u<1?f(z.target).fadeTo(0,u):f(z.target).show();e.loadCount--;if(e.loadCount<=0){k.children(':not([data-pixelSize="'+d+'"])').remove();z=k.find('[data-pixelSize="'+d+
'"]>div');if(z.size()>0){var A=z.position();z.children("img").each(function(){var y=f(this),x=A.left+parseInt(y.css("left")),C=A.top+parseInt(y.css("top"));y.css({left:x+"px",top:C+"px"})}).unwrap();z.remove()}e.loadCount=0}}).error(function(z){f(z.target).remove();e.loadCount--;if(e.loadCount<=0){k.children(":not([data-pixelSize='"+d+"'])").remove();e.loadCount=0}}).attr("src",c)}},opacity:function(a,b){q[b.id].serviceContainer.find("img").stop(true).fadeTo("fast",b.opacity)},_cancelUnloaded:function(a,
