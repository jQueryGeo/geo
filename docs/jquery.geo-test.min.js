...
b+'"></div>');this._$drawContainer=this._$contentFrame.children(":last");this._$contentFrame.append('<div class="geo-measure-container" style="position:absolute; left:0; top:0;'+b+'"><div class="geo-measure-label" style="position:absolute; left:0; top:0;; display: none;"></div></div>');this._$measureContainer=this._$contentFrame.children(":last");this._$measureLabel=this._$measureContainer.children();this._$panContainer=e([this._$shapesContainer[0],this._$drawContainer[0],this._$measureContainer[0]]);
this._$resizeContainer=e([this._$contentFrame[0],this._$servicesContainer[0],this._$eventTarget[0],this._$measureContainer[0]]);this._$contentFrame.append(this._$existingChildren);e("#geo-measure-style").length||e("head").prepend('<style type="text/css" id="geo-measure-style">.geo-measure-label { margin: 4px 0 0 6px; font-family: sans-serif;'+(r?"letter-spacing: 2px; color: #444; filter:progid:DXImageTransform.Microsoft.DropShadow(Color=white, OffX=1, OffY=2, Positive=true);":"color: #000; text-shadow: #fff 1px 2px; font-weight: bold;")+
" }</style>")},_createServices:function(){var b,c;for(c=0;c<this._currentServices.length;c++){this._currentServices[c].serviceContainer.geomap("destroy");e.geo._serviceTypes[this._currentServices[c].type].destroy(this,this._$servicesContainer,this._currentServices[c])}this._currentServices=[];this._$servicesContainer.html("");this._$attrList.html("");for(c=0;c<this._options.services.length;c++){b=this._currentServices[c]=e.extend({},this._options.services[c]);b.style=e.extend({visibility:"visible",
opacity:1},b.style);this._$servicesContainer.append("<div "+(b.id?' id="'+b.id+'"':"")+('class="geo-service '+(b["class"]?b["class"]:"")+'"')+' style="position:absolute; left:0; top:0; width:32px; height:32px; margin:0; padding:0; display:'+(b.style.visibility==="visible"?"block":"none")+';"></div>');serviceContainer=this._$servicesContainer.children(":last");this._currentServices[c].serviceContainer=serviceContainer;e.geo._serviceTypes[b.type].create(this,serviceContainer,b,c);serviceContainer.data("geoMap",
this).geomap();b.attr&&this._$attrList.append("<li>"+b.attr+"</li>")}this._$attrList.find("a").css({position:"relative",zIndex:100})},_refreshDrawing:function(){this._$drawContainer.geographics("clear");if(this._drawPixels.length>0){var b=this._options.mode,c=this._drawPixels,a=this._drawCoords,d,g;switch(b){case "measureLength":b="drawLineString";g={type:"LineString",coordinates:a};d=e.render({length:e.geo.length(g,true)},"geoMeasureLength");g=e.merge([],c[c.length-1]);break;case "measureArea":b=
"drawPolygon";g={type:"Polygon",coordinates:[e.merge([],a)]};g.coordinates[0].push(a[0]);d=e.render({area:e.geo.area(g,true)},"geoMeasureArea");g=e.merge([],c[c.length-1]);c=[c];break;case "drawPolygon":c=[c]}this._$drawContainer.geographics(b,c);if(d){this._$measureLabel.html(d);b=this._contentBounds.width-(this._$measureLabel.outerWidth(true)+g[0]);c=this._contentBounds.height-(this._$measureLabel.outerHeight(true)+g[1]);if(b<0)g[0]+=b;if(c<0)g[1]+=c;this._$measureLabel.css({left:g[0],top:g[1]}).show()}}},
_resetDrawing:function(){this._drawPixels=[];this._drawCoords=[];this._$drawContainer.geographics("clear");this._$measureLabel.hide()},_refreshShapes:function(b,c,a,d,g,f){var l,m,n,t,u,v,B,G=this._map._getBbox(g,f);for(l=0;l<c.length;l++){n=c[l].shape||c[l];n=n.geometry||n;m=e.data(n,"geoBbox");if(!(m&&e.geo._bboxDisjoint(G,m))){t=e.isArray(a)?a[l].style:a;u=e.isArray(d)?d[l].label:d;v=u!==q;B=q;switch(n.type){case "Point":B=this._map.toPixel(n.coordinates,g,f);this._$shapesContainer.geographics("drawPoint",
...
this._currentServices.length;c++){b=this._currentServices[c];if(!this._mouseDown&&e.geo._serviceTypes[b.type]!==null){e.geo._serviceTypes[b.type].refresh(this,b);b.serviceContainer.geomap("refresh")}}if(this._$shapesContainer){this._$shapesContainer.geographics("clear");this._graphicShapes.length>0&&this._refreshShapes(this._$shapesContainer,this._graphicShapes,this._graphicShapes,this._graphicShapes)}},_setCenterAndSize:function(b,c,a,d){if(this._pixelSize!=c){this._$elem.find(".geo-shapes-container").geographics("clear");
for(var g=0;g<this._currentServices.length;g++){var f=this._currentServices[g];e.geo._serviceTypes[f.type].interactiveScale(this,f,b,c)}}this._center=b;this._options.pixelSize=this._pixelSize=c;if(this._userGeodetic){this._options.bbox=e.geo.proj.toGeodetic(this._getBbox());this._options.center=e.geo.proj.toGeodetic(this._center)}else{this._options.bbox=this._getBbox();this._options.center=this._center}this._options.zoom=this._getZoom();if(this._drawCoords.length>0)this._drawPixels=this._toPixel(this._drawCoords);
a&&this._trigger("bboxchange",window.event,{bbox:this._options.bbox});if(d){this._refresh();this._refreshDrawing()}},_toMap:function(b,c,a){c=c||this._center;a=a||this._pixelSize;var d=e.isArray(b[0]),g=d&&e.isArray(b[0][0]),f=g&&e.isArray(b[0][0][0]),l=this._contentBounds.width,m=this._contentBounds.height,n=l/2*a;a=m/2*a;c=[c[0]-n,c[1]-a,c[0]+n,c[1]+a];l=e.geo.width(c,true)/l;m=e.geo.height(c,true)/m;a=this._options.axisLayout==="image";var t=[],u,v,B;if(!f){if(!g){d||(b=[b]);b=[b]}b=[b]}for(u=
0;u<b.length;u++){t[u]=[];for(v=0;v<b[u].length;v++){t[u][v]=[];for(B=0;B<b[u][v].length;B++){n=b[u][v][B][1]*m;t[u][v][B]=[c[0]+b[u][v][B][0]*l,a?c[1]+n:c[3]-n]}}}return f?t:g?t[0]:d?t[0][0]:t[0][0][0]},_toPixel:function(b,c,a){c=c||this._center;a=a||this._pixelSize;var d=e.isArray(b[0]),g=d&&e.isArray(b[0][0]),f=g&&e.isArray(b[0][0][0]),l=this._contentBounds.width,m=this._contentBounds.height,n=l/2*a;a=m/2*a;c=[c[0]-n,c[1]-a,c[0]+n,c[1]+a];var t=e.geo.width(c,true);a=e.geo.height(c,true);n=this._options.axisLayout===
"image";l=l/t;m=m/a;a=[];var u,v;if(!f){if(!g){d||(b=[b]);b=[b]}b=[b]}for(t=0;t<b.length;t++){a[t]=[];for(u=0;u<b[t].length;u++){a[t][u]=[];for(v=0;v<b[t][u].length;v++)a[t][u][v]=[Math.round((b[t][u][v][0]-c[0])*l),Math.round((n?b[t][u][v][1]-c[1]:c[3]-b[t][u][v][1])*m)]}}return f?a:g?a[0]:d?a[0][0]:a[0][0][0]},_zoomTo:function(b,c,a,d){c=c<0?0:c;var g=this._getTiledPixelSize(c);if(isNaN(g)){c=e.geo._scaleBy(this._getBboxMax(),1/Math.pow(this._zoomFactor,c),true);c=Math.max(e.geo.width(c,true)/this._contentBounds.width,
e.geo.height(c,true)/this._contentBounds.height);this._setCenterAndSize(b,c,a,d)}else this._setCenterAndSize(b,g,a,d)},_document_keydown:function(b){var c=this._drawCoords.length;if(c>0&&b.which==27)if(c<=2){this._resetDrawing();this._inOp=false}else{this._drawCoords[c-2]=e.merge([],this._drawCoords[c-1]);this._drawPixels[c-2]=e.merge([],this._drawPixels[c-1]);this._drawCoords.length--;this._drawPixels.length--;this._refreshDrawing()}},_eventTarget_dblclick_zoom:function(b){this._trigger("dblclick",
b,{type:"Point",coordinates:this.toMap(this._current)});if(!b.isDefaultPrevented()){b=this._getZoomCenterAndSize(this._current,1,true);this._setCenterAndSize(b.center,b.pixelSize,true,true)}},_eventTarget_dblclick:function(b){if(this._options.mode!=="static"){this._panFinalize();if(this._drawTimeout){window.clearTimeout(this._drawTimeout);this._drawTimeout=null}e(b.currentTarget).offset();switch(this._options.mode){case "drawLineString":if(this._drawCoords.length>1&&!(this._drawCoords[0][0]==this._drawCoords[1][0]&&
this._drawCoords[0][1]==this._drawCoords[1][1])){this._drawCoords.length--;this._trigger("shape",b,{type:"LineString",coordinates:this._userGeodetic?e.geo.proj.toGeodetic(this._drawCoords):this._drawCoords})}else this._eventTarget_dblclick_zoom(b);this._resetDrawing();break;case "drawPolygon":if(this._drawCoords.length>1&&!(this._drawCoords[0][0]==this._drawCoords[1][0]&&this._drawCoords[0][1]==this._drawCoords[1][1])){var c=this._drawCoords.length-1;if(c>2){this._drawCoords[c]=e.merge([],this._drawCoords[0]);
this._trigger("shape",b,{type:"Polygon",coordinates:[this._userGeodetic?e.geo.proj.toGeodetic(this._drawCoords):this._drawCoords]})}}else this._eventTarget_dblclick_zoom(b);this._resetDrawing();break;case "measureLength":case "measureArea":this._resetDrawing();break;default:this._eventTarget_dblclick_zoom(b)}this._inOp=false}},_eventTarget_touchstart:function(b){if(this._options.mode!=="static")if(!(!this._supportTouch&&b.which!=1))if(this._options.mode!=="static"){this._panFinalize();this._mouseWheelFinish();
var c=e(b.currentTarget).offset(),a=b.originalEvent.changedTouches;if(this._supportTouch){this._multiTouchAnchor=e.merge([],a);if(this._isMultiTouch=this._multiTouchAnchor.length>1){this._multiTouchCurrentBbox=[a[0].pageX-c.left,a[0].pageY-c.top,a[1].pageX-c.left,a[1].pageY-c.top];this._multiTouchAnchorBbox=e.merge([],this._multiTouchCurrentBbox);this._current=e.geo.center(this._multiTouchCurrentBbox,true)}else{this._multiTouchCurrentBbox=[a[0].pageX-c.left,a[0].pageY-c.top,NaN,NaN];this._current=
[a[0].pageX-c.left,a[0].pageY-c.top]}}else this._current=[b.pageX-c.left,b.pageY-c.top];if(this._softDblClick){c=e.now();if(c-this._downDate<750){if(this._isTap){a=this._current[0]-this._anchor[0];var d=this._current[1]-this._anchor[1];if(Math.sqrt(a*a+d*d)>10)this._isTap=false;else this._current=this._anchor}this._isDbltap=this._isDbltap?false:this._isTap}else this._isDbltap=false;this._isTap=true;this._downDate=c}this._mouseDown=true;this._anchor=this._current;if(!this._inOp&&b.shiftKey){this._shiftZoom=
true;this._$eventTarget.css("cursor",this._options.cursors.zoom)}else if(!this._isMultiTouch&&this._options.pannable){this._inOp=true;switch(this._options.mode){case "zoom":break;default:this._lastDrag=this._current;b.currentTarget.setCapture&&b.currentTarget.setCapture()}}b.preventDefault();return false}},_dragTarget_touchmove:function(b){if(this._options.mode!=="static"){var c=this._$eventTarget.offset(),a=this._drawCoords.length,d=b.originalEvent.changedTouches,g;g=0;if(this._supportTouch){if(!this._isMultiTouch&&
d[0].identifier!==this._multiTouchAnchor[0].identifier){this._mouseDown=false;this._dragTarget_touchstop(b);this._isMultiTouch=true;this._multiTouchAnchor.push(d[0]);this._multiTouchCurrentBbox=[this._multiTouchCurrentBbox[0],this._multiTouchCurrentBbox[1],this._multiTouchAnchor[1].pageX-c.left,this._multiTouchAnchor[1].pageY-c.top];this._multiTouchAnchorBbox=e.merge([],this._multiTouchCurrentBbox);this._mouseDown=true;this._anchor=this._current=e.geo.center(this._multiTouchCurrentBbox,true);return false}if(this._isMultiTouch){for(;g<
d.length;g++)if(d[g].identifier===this._multiTouchAnchor[0].identifier){this._multiTouchCurrentBbox[0]=d[g].pageX-c.left;this._multiTouchCurrentBbox[1]=d[g].pageY-c.top}else if(d[g].identifier===this._multiTouchAnchor[1].identifier){this._multiTouchCurrentBbox[2]=d[g].pageX-c.left;this._multiTouchCurrentBbox[3]=d[g].pageY-c.top}e.geo.center(this._multiTouchCurrentBbox,true);g=this._multiTouchCurrentBbox[2]-this._multiTouchCurrentBbox[0];c=this._multiTouchAnchorBbox[2]-this._multiTouchAnchorBbox[0];
this._wheelLevel=Math.abs(Math.floor((1-g/c)*10));if(Math.abs(g)<Math.abs(c))this._wheelLevel=-this._wheelLevel;d=this._getZoomCenterAndSize(this._anchor,this._wheelLevel,false);this._$elem.find(".geo-shapes-container").geographics("clear");for(g=0;g<this._currentServices.length;g++){c=this._currentServices[g];e.geo._serviceTypes[c.type].interactiveScale(this,c,d.center,d.pixelSize)}this._graphicShapes.length>0&&this._graphicShapes.length<256&&this._refreshShapes(this._$shapesContainer,this._graphicShapes,
this._graphicShapes,this._graphicShapes,d.center,d.pixelSize);if(this._drawCoords.length>0){this._drawPixels=this._toPixel(this._drawCoords,d.center,d.pixelSize);this._refreshDrawing()}g=e.geo.center(this._multiTouchCurrentBbox,true)}else g=[b.originalEvent.changedTouches[0].pageX-c.left,b.originalEvent.changedTouches[0].pageY-c.top]}else g=[b.pageX-c.left,b.pageY-c.top];if(g[0]===this._lastMove[0]&&g[1]===this._lastMove[1])if(this._inOp){b.preventDefault();return false}if(this._softDblClick)this._isDbltap=
this._isTap=false;if(this._mouseDown){this._current=g;this._moveDate=e.now()}if(this._isMultiTouch){b.preventDefault();return false}switch(this._shiftZoom?"zoom":this._options.mode){case "zoom":if(this._mouseDown){this._$drawContainer.geographics("clear");this._$drawContainer.geographics("drawBbox",[this._anchor[0],this._anchor[1],g[0],g[1]])}else this._trigger("move",b,{type:"Point",coordinates:this.toMap(g)});break;case "drawLineString":case "drawPolygon":case "measureLength":case "measureArea":if(this._mouseDown||
this._toolPan)this._panMove();else{if(a>0){this._drawCoords[a-1]=this._toMap(g);this._drawPixels[a-1]=g;this._refreshDrawing()}this._trigger("move",b,{type:"Point",coordinates:this.toMap(g)})}break;default:this._mouseDown||this._toolPan?this._panMove():this._trigger("move",b,{type:"Point",coordinates:this.toMap(g)})}this._lastMove=g;if(this._inOp){b.preventDefault();return false}}},_dragTarget_touchstop:function(b){if(this._options.mode!=="static"){!this._mouseDown&&r==7&&this._eventTarget_touchstart(b);
var c=this._mouseDown,a=this._toolPan,d=this._$eventTarget.offset(),g=this._shiftZoom?"zoom":this._options.mode,f,l;f=this._supportTouch?[b.originalEvent.changedTouches[0].pageX-d.left,b.originalEvent.changedTouches[0].pageY-d.top]:[b.pageX-d.left,b.pageY-d.top];d=f[0]-this._anchor[0];l=f[1]-this._anchor[1];this._$eventTarget.css("cursor",this._options.cursors[this._options.mode]);this._shiftZoom=this._mouseDown=this._toolPan=false;if(this._isMultiTouch){b.preventDefault();this._isMultiTouch=false;
c=this._getZoomCenterAndSize(this._anchor,this._wheelLevel,false);this._setCenterAndSize(c.center,c.pixelSize,true,true);this._wheelLevel=0;return false}document.releaseCapture&&document.releaseCapture();if(c){c=e.now();this._current=f;switch(g){case "zoom":if(d>0||l>0){a=this._pixelSize*6;g=this._toMap([[Math.min(this._anchor[0],f[0]),Math.max(this._anchor[1],f[1])],[Math.max(this._anchor[0],f[0]),Math.min(this._anchor[1],f[1])]]);g=[g[0][0],g[0][1],g[1][0],g[1][1]];if(g[2]-g[0]<a&&g[3]-g[1]<a)g=
e.geo.scaleBy(this._getBbox(e.geo.center(g,true)),0.5,true);this._setBbox(g,true,true)}this._resetDrawing();break;case "drawPoint":if(this._drawTimeout){window.clearTimeout(this._drawTimeout);this._drawTimeout=null}if(a)this._panFinalize();else if(c-this._clickDate>100){var m=this;this._drawTimeout=setTimeout(function(){if(m._drawTimeout){m._trigger("shape",b,{type:"Point",coordinates:m.toMap(f)});m._inOp=false;m._drawTimeout=null}},250)}break;case "drawLineString":case "drawPolygon":case "measureLength":case "measureArea":if(a)this._panFinalize();
...
D,P=Math.floor((n.origin[1]+m*y[3])/(K*u))*D;y=n.origin[1]+m*P*u*d;var I=Math.round((n.origin[0]+J*t*d-a[0])/d),C=Math.round((l?y-a[1]:a[3]-y)/d);a=f.children().show();l=a.filter("[data-pixelSize='"+d+"']").appendTo(f);var H=b.style.opacity;c.reloadTiles&&a.find("img").attr("data-dirty","true");if(l.size()){l.css({left:I%t+"px",top:C%u+"px"}).data("scaleOrigin",I%t+","+C%u);l.children().each(function(){var L=e(this),R=L.attr("data-tile").split(",");L.css({left:Math.round((parseInt(R[0])-J)*100+(I-
...
[n.origin[0]+((v+1)*t-1)*d,n.origin[1]+m*((y+1)*u-1)*d];z=[D[0],D[1],z[0],z[1]];D=b.hasOwnProperty("src")?"src":"getUrl";z={bbox:z,width:t,height:u,zoom:r._getZoom(),tile:{row:y,column:v},index:Math.abs(y+v)};if(e.isFunction(b[D]))D=b[D](z);else{e.template("geoSrc",b[D]);D=e.render(z,"geoSrc")}c.loadCount++;if(c.reloadTiles&&M.size()>0)M.attr("src",D);else{z="<img style='position:absolute; left:"+((v-J)*100+(I-I%t)/t*100)+"%; top:"+((y-P)*100+(C-C%u)/u*100)+"%; ";if(e("body")[0].filters===q)z+="width: 100%; height: 100%;";
...
r,b,c){var a=e.data(r,"geoServiceState");if(a){this._cancelUnloaded(q,r);q=a.serviceContainer.children("[data-pixelSize='"+q._pixelSize+"']");r=q.children("div");if(!r.length){q.children("img").wrap('<div style="position:absolute; left:0; top:0; width:100%; height:100%;"></div>');r=q.children("div")}r.css({left:function(d,g){return parseInt(g)+b},top:function(d,g){return parseInt(g)+c}})}},interactiveScale:function(q,r,b,c){var a=e.data(r,"geoServiceState");if(a){this._cancelUnloaded(q,r);r=a.serviceContainer;
q=q._getContentBounds();var d=q.width,g=q.height,f=d/2,l=g/2;r.children().each(function(){var m=e(this),n=m.attr("data-pixelSize"),t=n/c;m.css({width:d*t,height:g*t}).children("img").each(function(){var u=e(this),v=u.data("center");u.css({left:(Math.round((v[0]-b[0])/n)-f)*t+"px",top:(Math.round((b[1]-v[1])/n)-l)*t+"px"})})})}},refresh:function(q,r){var b=e.data(r,"geoServiceState");this._cancelUnloaded(q,r);if(b&&r&&r.style.visibility==="visible"&&!b.serviceContainer.is(":hidden")){var c=q._getBbox(),
a=q._pixelSize,d=this,g=b.serviceContainer,f=q._getContentBounds(),l=f.width,m=f.height,n=l/2,t=m/2;f=g.children('[data-pixelSize="'+a+'"]');var u=r.style.opacity,v;if(!f.size()){g.append('<div style="position:absolute; left:'+n+"px; top:"+t+"px; width:"+l+"px; height:"+m+'px; margin:0; padding:0;" data-pixelSize="'+a+'"></div>');f=g.children(":last")}f.children("img").each(function(){var G=e(this),F=G.data("center"),y=q._getCenter();G.css({left:Math.round((F[0]-y[0])/a)-n+"px",top:Math.round((y[1]-
