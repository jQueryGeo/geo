...
(function(e,m){var n="center",l,d={},f,h,j,k,r,p,t,x,B,w,q,u,v,Y,Z,V,P,W,E,Q,fa=function(){for(var a=5,b=document.createElement("div"),g=b.all||[];b.innerHTML="<!--[if gt IE "+ ++a+"]><br><![endif]--\>",g[0];);return a>6?a:!a}(),M,$=this._supportTouch||this._ieVersion==7,R,O,N={},o={},ha={bbox:[-180,-90,180,90],bboxMax:[-180,-90,180,90],center:[0,0],cursors:{pan:"move"},mode:"pan",services:[{id:"OSM",type:"tiled",getUrl:function(a){return"http://tile.openstreetmap.org/"+a.zoom+"/"+a.tile.column+"/"+
...
false);k.css("cursor",o.cursors[o.mode]);this._createServices();this._refresh()},_setOption:function(a,b,g){g=g===m||g;switch(a){case "bbox":if(e.geo.proj){b=e.geo.proj.fromGeodetic([[b[0],b[1]],[b[2],b[3]]]);b=[b[0][0],b[0][1],b[1][0],b[1][1]]}this._setBbox(b,false,g);b=this._getBbox();if(e.geo.proj){b=e.geo.proj.toGeodetic([[b[0],b[1]],[b[2],b[3]]]);b=[b[0][0],b[0][1],b[1][0],b[1][1]]}break;case "center":this._setCenterAndSize(e.geo.proj?e.geo.proj.fromGeodetic([[b[0],b[1]]])[0]:b,r,false,g);break;
case "zoom":this._setZoom(b,false,g)}e.Widget.prototype._setOption.apply(this,arguments)},destroy:function(){e.Widget.prototype.destroy.apply(this,arguments);this.element.html("")},getPixelSize:function(){return r},_getBbox:function(){var a=d.width/2*r,b=d.height/2*r;return[n[0]-a,n[1]-b,n[0]+a,n[1]+b]},_setBbox:function(a,b,g){var z=[a[0]+(a[2]-a[0])/2,a[1]+(a[3]-a[1])/2];a=Math.max(e.geo._width(a)/d.width,e.geo._height(a)/d.height);if(o.tilingScheme)a=this._getTiledPixelSize(this._getTiledZoom(a));
...
A,y[3]-this[1]*F]});return z?S:S[0]},_zoomTo:function(a,b){b=b<0?0:b;var g=this._getTiledPixelSize(b);if(isNaN(g)){g=e.geo._scaleBy(this._getBboxMax(),1/Math.pow(2,b));g=Math.max(e.geo._width(g)/d.width,e.geo._height(g)/d.height);this._setCenterAndSize(a,g,false,true)}else this._setCenterAndSize(a,g,false,true)},_eventTarget_dblclick:function(a){this._panFinalize();offset=e(a.currentTarget).offset();switch(o.mode){case "pan":this._zoomTo(this._toMap(v),this._getZoom()+1)}B=false},_eventTarget_touchstart:function(a){if(!(!M&&
a.which!=1)){if($){var b=e.now();O=b-Y<750?O?false:R:false;R=true;Y=b}a.preventDefault();this._panFinalize();b=e(a.currentTarget).offset();v=M?[a.originalEvent.changedTouches[0].pageX-b.left,a.originalEvent.changedTouches[0].pageY-b.top]:[a.pageX-b.left,a.pageY-b.top];x=true;u=v;if(!B&&a.shiftKey){q=true;k.css("cursor",o.cursors.zoom)}else{B=true;switch(o.mode){case "pan":P=v;a.currentTarget.setCapture&&a.currentTarget.setCapture()}}return false}},_dragTarget_touchmove:function(a){var b=k.offset();
a=M?[a.originalEvent.changedTouches[0].pageX-b.left,a.originalEvent.changedTouches[0].pageY-b.top]:[a.pageX-b.left,a.pageY-b.top];if(!(a[0]==V[0]&&a[1]==V[1])){if($)O=R=false;if(x){v=a;Z=e.now()}switch(q?"zoom":o.mode){case "pan":x&&this._panMove()}V=a}},_dragTarget_touchstop:function(a){!x&&fa==7&&this._eventTarget_touchstart(a);var b=x,g=k.offset();g=M?[a.originalEvent.changedTouches[0].pageX-g.left,a.originalEvent.changedTouches[0].pageY-g.top]:[a.pageX-g.left,a.pageY-g.top];var z=q?"zoom":o.mode;
